...
In addition to the generated `ports\<package>\portfile.cmake`, we also need a `ports\<package>\CONTROL` file. This file is simply a formatted set of fields describing the package's metadata.

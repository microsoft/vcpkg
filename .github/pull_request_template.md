...
Replace REPLACE_WITH_PORT_NAME with the actual port name in the checks below.
...
- [ ] The packaged project shows strong association with the chosen port name. Check this box if at least one of the following criteria is met:
    - [ ] The project is in Repology: https://repology.org/project/REPLACE_WITH_PORT_NAME/versions
    - [ ] The project is amongst the first web search results for "REPLACE_WITH_PORT_NAME" or "REPLACE_WITH_PORT_NAME C++". Include a screenshot of the search engine results in the PR.

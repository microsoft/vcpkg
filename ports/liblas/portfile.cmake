...
string(REPLACE "" "" RELEASE_CONFIG "${RELEASE_CONFIG}")
file(WRITE ${CURRENT_PACKAGES_DIR}/share/${PORT}/liblas-depends-release.cmake "${RELEASE_CONFIG}")
file(READ ${CURRENT_PACKAGES_DIR}/share/${PORT}/liblas-depends-release.cmake DEBUG_CONFIG)
string(REPLACE "${CURRENT_INSTALLED_DIR}" "\${_IMPORT_PREFIX}" DEBUG_CONFIG "${DEBUG_CONFIG}")
file(WRITE ${CURRENT_PACKAGES_DIR}/share/${PORT}/liblas-depends-release.cmake "${DEBUG_CONFIG}")

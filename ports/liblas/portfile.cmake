...
if (VCPKG_TARGET_IS_WINDOWS)
    ...
    file(TO_NATIVE_PATH "${CURRENT_INSTALLED_DIR}/lib/sqlite3.lib" SQLITE3_LIBRARY_REL)
    file(TO_NATIVE_PATH "${CURRENT_INSTALLED_DIR}/debug/lib/sqlite3.lib" SQLITE3_LIBRARY_DBG)
else()
    file(TO_NATIVE_PATH "${CURRENT_INSTALLED_DIR}/lib/libproj.a" PROJ_LIBRARY_REL)
    file(TO_NATIVE_PATH "${CURRENT_INSTALLED_DIR}/debug/lib/libproj.a" PROJ_LIBRARY_DBG)
    file(TO_NATIVE_PATH "${CURRENT_INSTALLED_DIR}/lib/libsqlite3.a" SQLITE3_LIBRARY_REL)
    file(TO_NATIVE_PATH "${CURRENT_INSTALLED_DIR}/debug/lib/libsqlite3.a" SQLITE3_LIBRARY_DBG)
endif()

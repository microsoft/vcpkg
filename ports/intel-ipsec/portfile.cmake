...
if (CMAKE_HOST_WIN32)
    ...
    if(NOT "${VCPKG_BUILD_TYPE}" STREQUAL "release")
        ...
        if ("${VCPKG_LIBRARY_LINKAGE}" STREQUAL "static")
            file(INSTALL "${DEBUG_LIB}/libIPSec_MB.pdb" DESTINATION "${CURRENT_PACKAGES_DIR}/debug/lib")
    ...
    if ("${VCPKG_LIBRARY_LINKAGE}" STREQUAL "static")
        file(INSTALL "${RELEASE_LIB}/libIPSec_MB.pdb" DESTINATION "${CURRENT_PACKAGES_DIR}/lib")

...
vcpkg_execute_build_process(
            COMMAND ${BAZEL} build --verbose_failures --strategy=CppCompile=standalone //ryu //ryu:generic_128 //ryu:ryu_printf
...
if (CMAKE_HOST_WIN32)
    ...
    file(INSTALL ${SOURCE_PATH}/bazel-bin/ryu/generic_128.lib DESTINATION ${CURRENT_PACKAGES_DIR}/lib/)
    file(INSTALL ${SOURCE_PATH}/bazel-bin/ryu/generic_128.lib DESTINATION ${CURRENT_PACKAGES_DIR}/debug/lib/)    
    ...
    file(INSTALL ${SOURCE_PATH}/bazel-bin/ryu/libgeneric_128.a DESTINATION ${CURRENT_PACKAGES_DIR}/lib/)
    file(INSTALL ${SOURCE_PATH}/bazel-bin/ryu/libgeneric_128.a DESTINATION ${CURRENT_PACKAGES_DIR}/debug/lib/)
...
file(INSTALL ${SOURCE_PATH}/ryu/ryu_generic_128.h DESTINATION ${CURRENT_PACKAGES_DIR}/include/ryu/)

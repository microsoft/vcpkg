...
if(UNIX AND NOT "fontconfig" IN_LIST FEATURES)
...
if (VCPKG_LIBRARY_LINKAGE STREQUAL dynamic)
    vcpkg_configure_cmake(
        ...
        OPTIONS -DPODOFO_BUILD_LIB_ONLY=1 -DPODOFO_BUILD_SHARED=1 -DPODOFO_NO_FONTMANAGER=${PODOFO_NO_FONTMANAGER}
    )
elseif (VCPKG_LIBRARY_LINKAGE STREQUAL static)
    vcpkg_configure_cmake(
        SOURCE_PATH ${SOURCE_PATH}
        OPTIONS -DPODOFO_BUILD_LIB_ONLY=1 -DPODOFO_BUILD_STATIC=1 -DPODOFO_NO_FONTMANAGER=${PODOFO_NO_FONTMANAGER}
    )
endif()

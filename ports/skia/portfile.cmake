...
if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "debug")
    ...
    gn_desc_target_defines(SKIA_DEFINITIONS_DBG
        "${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-dbg"
        //:skia)
    string(REPLACE "SKIA_IMPLEMENTATION=1" "SKIA_IMPLEMENTATION=0" SKIA_DEFINITIONS_DBG "${SKIA_DEFINITIONS_DBG}")
endif()
...
if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "release")
    ...
    gn_desc_target_defines(SKIA_DEFINITIONS_REL
        "${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-rel"
        //:skia)
    string(REPLACE "SKIA_IMPLEMENTATION=1" "SKIA_IMPLEMENTATION=0" SKIA_DEFINITIONS_REL "${SKIA_DEFINITIONS_REL}")
endif()

...
if(NOT TARGET @cmake_target@)
    if("@SKIA_LIB_REL@" STREQUAL "")
        add_library(@cmake_target@ INTERFACE IMPORTED)
        set_target_properties(@cmake_target@ PROPERTIES
            INTERFACE_LINK_LIBRARIES "\$<LINK_ONLY:@SKIA_DEP@>"
        )
    else()
        add_library(@cmake_target@ UNKNOWN IMPORTED)
        ...
        set_property(TARGET @cmake_target@ APPEND PROPERTY

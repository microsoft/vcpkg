...
if (VCPKG_TARGET_IS_WINDOWS)
  # libxml2
  find_library(LIBXML2_LIBS_REL NAMES xml2 libxml2 libxml2s ${REL_NAMES} PATHS "${CURRENT_INSTALLED_DIR}/lib" NO_DEFAULT_PATH) 
  find_library(LIBXML2_LIBS_DBG NAMES xml2d xml2d libxml2d libxml2sd ${DBG_NAMES} PATHS "${CURRENT_INSTALLED_DIR}/debug/lib" NO_DEFAULT_PATH)
  # expat
  find_library(EXPAT_LIBS_REL NAMES expat libexpat libexpatMD ${REL_NAMES} PATHS "${CURRENT_INSTALLED_DIR}/lib" NO_DEFAULT_PATH) 
  find_library(EXPAT_LIBS_DBG NAMES expat expatd libexpatd libexpatdMD ${DBG_NAMES} PATHS "${CURRENT_INSTALLED_DIR}/debug/lib" NO_DEFAULT_PATH)

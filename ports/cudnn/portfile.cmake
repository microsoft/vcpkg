...
vcpkg_download_distfile(ARCHIVE
    ...
    FILENAME "cudnn-${CUDNN_FULL_VERSION}.tar.bz2"
    SHA512 ${SHA512_CUDNN}
)
...
if(VCPKG_TARGET_IS_WINDOWS)
  ...
  file(INSTALL "${STATIC_LIBS}/lib/x64/cudnn.lib" DESTINATION ${CURRENT_PACKAGES_DIR}/lib)
  file(INSTALL "${STATIC_LIBS}/bin/cudnn64_7.dll" DESTINATION ${CURRENT_PACKAGES_DIR}/bin)
elseif(VCPKG_TARGET_IS_LINUX)
  file(INSTALL "${SOURCE_PATH}/include/cudnn.h" DESTINATION ${CURRENT_PACKAGES_DIR}/include)
  file(INSTALL "${STATIC_LIBS}/lib/libcudnn.so.${CUDNN_VERSION}" DESTINATION ${CURRENT_PACKAGES_DIR}/lib)
  file(INSTALL "${STATIC_LIBS}/lib/libcudnn.so.7" DESTINATION ${CURRENT_PACKAGES_DIR}/lib)
  file(INSTALL "${STATIC_LIBS}/lib/libcudnn.so" DESTINATION ${CURRENT_PACKAGES_DIR}/lib)
  file(INSTALL "${STATIC_LIBS}/lib/libcudnn.so.${CUDNN_VERSION}" DESTINATION ${CURRENT_PACKAGES_DIR}/debug/lib)
  file(INSTALL "${STATIC_LIBS}/lib/libcudnn.so.7" DESTINATION ${CURRENT_PACKAGES_DIR}/debug/lib)
  file(INSTALL "${STATIC_LIBS}/lib/libcudnn.so" DESTINATION ${CURRENT_PACKAGES_DIR}/debug/lib)
endif()

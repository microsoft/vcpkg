...
if(VCPKG_TARGET_IS_WINDOWS)
  ...
  file(INSTALL "${SOURCE_PATH}/Library/bin/cudnn64_7.dll" DESTINATION ${CURRENT_PACKAGES_DIR}/bin)
  file(INSTALL "${SOURCE_PATH}/Library/lib/x64/cudnn.lib" DESTINATION ${CURRENT_PACKAGES_DIR}/debug/lib)
  file(INSTALL "${SOURCE_PATH}/Library/bin/cudnn64_7.dll" DESTINATION ${CURRENT_PACKAGES_DIR}/debug/bin)
elseif(VCPKG_TARGET_IS_LINUX)
  ...
  file(INSTALL "${SOURCE_PATH}/lib/libcudnn.so.7" DESTINATION ${CURRENT_PACKAGES_DIR}/lib)
  ...
  file(INSTALL "${SOURCE_PATH}/lib/libcudnn.so.7" DESTINATION ${CURRENT_PACKAGES_DIR}/debug/lib)

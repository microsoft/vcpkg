...
if(WIN32)
  ...
  find_file(CUDNN_LIBRARY_DLL NAMES cudnn64_${_CUDNN_VERSION_MAJOR}.dll PATHS ${CUDNN_DLL_DIR})

  if (NOT CUDNN_LIBRARY_DLL)
    get_filename_component(_CUDA_VERSION ${CUDNN_INCLUDE_DIR} NAME)
    set(CUDNN_DLL_DIR ${CUDNN_INCLUDE_DIR})
    list(TRANSFORM CUDNN_DLL_DIR APPEND "/../../bin/${_CUDA_VERSION}")
    find_file(CUDNN_LIBRARY_DLL NAMES cudnn64_${_CUDNN_VERSION_MAJOR}.dll PATHS ${CUDNN_DLL_DIR})
  endif()
endif()

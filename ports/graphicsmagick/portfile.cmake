...
set(DEFINITIONS_FLAGS "-D_MAGICKLIB_ -D_WANDLIB_ -DMAGICK_IMPLEMENTATION")
# if(BUILD_SHARED_LIBS)
if(VCPKG_LIBRARY_LINKAGE STREQUAL dynamic)
    set(DEFINITIONS_FLAGS "${DEFINITIONS_FLAGS} -D_DLL -DDLL")
endif()
# if(MSVC)
if(VCPKG_TARGET_IS_WINDOWS AND NOT VCPKG_TARGET_IS_MINGW AND NOT VCPKG_TARGET_IS_UWP)
    set(DEFINITIONS_FLAGS "${DEFINITIONS_FLAGS} -D_VISUALC_ -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE")
endif()
# if(WIN32)
if(VCPKG_TARGET_IS_WINDOWS)
    set(DEFINITIONS_FLAGS "${DEFINITIONS_FLAGS} -DWIN32 -D_WIN32 -D_WIN32_WINNT=0x0501")
endif()
...
vcpkg_make_configure(
    ...
    OPTIONS
        VERBOSE=yes
        "CXXFLAGS=\$CXXFLAGS ${DEFINITIONS_FLAGS}"
        "CFLAGS=\$CFLAGS ${DEFINITIONS_FLAGS}"
)

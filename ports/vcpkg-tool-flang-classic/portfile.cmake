...
vcpkg_from_github(
    ...
    PATCHES awk.patch
            ...
            ${PATCH_1341}
            ${PATCH_1344}
            #${PATCH_1345} # already patched into
            ${PATCH_1346}
            #fix-build.patch
)
...
file(MAKE_DIRECTORY "${CURRENT_PACKAGES_DIR}/manual-tools/llvm-flang-classic/")
file(RENAME "${CURRENT_PACKAGES_DIR}/bin" "${CURRENT_PACKAGES_DIR}/manual-tools/llvm-flang-classic/bin" )

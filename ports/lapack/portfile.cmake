...
set(DEFAULT_LAPACK "default-lapack" IN_LIST FEATURES AND NOT "force-reference-lapack" IN_LIST FEATURES)
...
if("default-lapack" IN_LIST FEATURES OR "force-reference-lapack" IN_LIST FEATURES)
    if((VCPKG_TARGET_IS_OSX OR VCPKG_TARGET_IS_IOS) AND DEFAULT_LAPACK)
...
elseif()
    MESSAGE(FATAL_ERROR "Cannot have neither `default-lapack` or `force-reference-lapack` enabled.")
endif()

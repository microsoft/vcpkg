...
if(ver_str STREQUAL "default")
    ...
    if(VCPKG_TARGET_IS_OSX)
        ...
        configure_file("${CMAKE_CURRENT_LIST_DIR}/lapack.pc.in" "${CURRENT_PACKAGES_DIR}/lib/pkgconfig/lapack.pc" COPYONLY)
        if(NOT VCPKG_BUILD_TYPE)
            configure_file("${CMAKE_CURRENT_LIST_DIR}/lapack.pc.in" "${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/lapack.pc" COPYONLY)
        endif()

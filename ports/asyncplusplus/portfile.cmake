...
file(COPY ${CURRENT_PACKAGES_DIR}/debug/cmake/Async++-debug.cmake DESTINATION ${CURRENT_PACKAGES_DIR}/share/asyncplusplus/Async++-debug.cmake)
file(COPY ${CURRENT_PACKAGES_DIR}/cmake/Async++-release.cmake DESTINATION ${CURRENT_PACKAGES_DIR}/share/asyncplusplus/Async++-release.cmake)
file(COPY ${CURRENT_PACKAGES_DIR}/cmake/Async++.cmake DESTINATION ${CURRENT_PACKAGES_DIR}/share/asyncplusplus/Async++.cmake)
file(COPY ${CURRENT_PACKAGES_DIR}/cmake/Async++Config.cmake DESTINATION ${CURRENT_PACKAGES_DIR}/share/asyncplusplus/Async++Config.cmake)

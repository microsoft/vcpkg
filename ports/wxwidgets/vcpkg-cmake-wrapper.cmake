...
file(GLOB WX_DEBUG_LIBS "${wxWidgets_ROOT_DIR}/debug/lib/wx*.lib")
...
if(wxWidgets_LIBRARIES AND NOT wxWidgets_LIBRARIES MATCHES "^debug;")
    ...
    list(APPEND wxWidgets_LIBRARIES "@system_LIBRARIES@")
endif()

...
if (NOT VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL release)
    ...
    set(REL_BIN_PATH ${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-rel)
endif()
...
if (NOT VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL debug)
    ...
    set(DBG_BIN_PATH ${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-dbg)
endif()
...
if (VCPKG_TARGET_IS_WINDOWS)
    ...
    file(GLOB LIB_FILES ${CURRENT_PACKAGES_DIR}/bin/*${VCPKG_TARGET_STATIC_LIBRARY_PREFIX} ${CURRENT_PACKAGES_DIR}/debug/bin/*${VCPKG_TARGET_STATIC_LIBRARY_PREFIX})
    file(GLOB EXE_FILES_REL ${CURRENT_PACKAGES_DIR}/bin/*${VCPKG_TARGET_EXECUTABLE_SUFFIX} ${REL_BIN_PATH}/*${VCPKG_TARGET_EXECUTABLE_SUFFIX})
    file(GLOB EXE_FILES_DBG ${CURRENT_PACKAGES_DIR}/debug/bin/*${VCPKG_TARGET_EXECUTABLE_SUFFIX} ${DBG_BIN_PATH}/*${VCPKG_TARGET_EXECUTABLE_SUFFIX})

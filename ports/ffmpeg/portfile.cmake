...
set(linker_flags_var "VCPKG_DETECTED_CMAKE_STATIC_LINKER_FLAGS")
if(VCPKG_LIBRARY_LINKAGE STREQUAL "dynamic")
    set(linker_flags_var "VCPKG_DETECTED_CMAKE_SHARED_LINKER_FLAGS")
...
if (NOT VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "release")
    ...
    string(REPLACE "-nologo" "" VCPKG_DETECTED_CMAKE_C_FLAGS_RELEASE "${VCPKG_DETECTED_CMAKE_C_FLAGS_RELEASE}")
    string(REPLACE "-nologo" "" ${linker_flags_var}_RELEASE "${${linker_flags_var}_RELEASE}")
...
if (NOT VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "debug")
    ...
    string(REPLACE "-nologo" "" VCPKG_DETECTED_CMAKE_C_FLAGS_DEBUG "${VCPKG_DETECTED_CMAKE_C_FLAGS_DEBUG}")
    string(REPLACE "-nologo" "" ${linker_flags_var}_DEBUG "${${linker_flags_var}_DEBUG}")

...
set(MESSAGE_TYPE_GPL FATAL_ERROR)
set(MESSAGE_TYPE_NONFREE FATAL_ERROR)
if("all" IN_LIST FEATURES)
    set(MESSAGE_TYPE WARNING)
    if("all-gpl" IN_LIST FEATURES)
        set(MESSAGE_TYPE_GPL WARNING)
    endif()
    if("all-nonfree" IN_LIST FEATURES)
        set(MESSAGE_TYPE_NONFREE WARNING)
    endif()
endif()
...
if("avisynthplus" IN_LIST FEATURES)
    if (VCPKG_TARGET_ARCHITECTURE STREQUAL "arm" OR VCPKG_TARGET_ARCHITECTURE STREQUAL "arm64" OR (NOT "${VCPKG_CMAKE_SYSTEM_NAME}" STREQUAL ""))
        message(${MESSAGE_TYPE_GPL} "Feature 'avisynthplus' does not support '!windows | arm | uwp'")
...
if("fdk-aac" IN_LIST FEATURES)
    if (VCPKG_TARGET_ARCHITECTURE STREQUAL "arm" OR VCPKG_TARGET_ARCHITECTURE STREQUAL "arm64" OR VCPKG_CMAKE_SYSTEM_NAME STREQUAL "WindowsStore")
        message(${MESSAGE_TYPE_NONFREE} "Feature 'fdk-aac' does not support 'uwp | arm'")
...
if("x264" IN_LIST FEATURES)
    if (VCPKG_TARGET_ARCHITECTURE STREQUAL "arm" OR VCPKG_TARGET_ARCHITECTURE STREQUAL "arm64")
        message(${MESSAGE_TYPE_GPL} "Feature 'x264' does not support 'arm'")
...
if("x265" IN_LIST FEATURES)
    if (VCPKG_TARGET_ARCHITECTURE STREQUAL "arm" OR VCPKG_TARGET_ARCHITECTURE STREQUAL "arm64" OR VCPKG_CMAKE_SYSTEM_NAME STREQUAL "WindowsStore")
        message(${MESSAGE_TYPE_GPL} "Feature 'x265' does not support 'uwp | arm'")

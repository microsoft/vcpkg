...
list(APPEND OPTIONS_DISABLE cuda nvdec)
feature_list(nvcodec APPEND OPTIONS_ENABLE cuda nvdec)

list(REMOVE_DUPLICATES OPTIONS_ENABLE)
if(OPTIONS_ENABLE)
    list(REMOVE_ITEM OPTIONS_DISABLE ${OPTIONS_ENABLE})
endif()
list(TRANSFORM OPTIONS_ENABLE PREPEND "--enable-")
list(TRANSFORM OPTIONS_DISABLE PREPEND "--disable-")
set(CONFIGURE_ALL ${OPTIONS_DISABLE})
if(OPTIONS_ENABLE)
    list(APPEND CONFIGURE_ALL ${OPTIONS_ENABLE})
endif()

...
set(MKL_REQUIRED_VERSION "2020.00.00")

set(ProgramFilesx86 "ProgramFiles(x86)")
set(INTEL_ROOT "$ENV{${ProgramFilesx86}}/IntelSWTools/compilers_and_libraries/windows")
set(INTEL_ONEAPI_MKL_ROOT "$ENV{${ProgramFilesx86}}/Intel/oneAPI/mkl/latest")

message(STATUS )
find_path(MKL_ROOT mkl.h PATHS "$ENV{MKLROOT}" "${INTEL_ROOT}/mkl" "${INTEL_ONEAPI_MKL_ROOT}" PATH_SUFFIXES include DOC "Folder contains MKL")

...
if(VCPKG_TARGET_IS_WINDOWS)
    ...
    foreach(file IN LISTS files)
      file(COPY "${mkl_dir}/lib/intel64/${file}" DESTINATION "${CURRENT_PACKAGES_DIR}/lib")
      if(NOT VCPKG_BUILD_TYPE)
        file(COPY "${mkl_dir}/lib/intel64/${file}" DESTINATION "${CURRENT_PACKAGES_DIR}/debug/lib")
      endif()
    endforeach()
    ...
    if(threading STREQUAL "intel_thread")
      ...
      file(COPY "${compiler_dir}/windows/compiler/lib/intel64_win/" DESTINATION "${CURRENT_PACKAGES_DIR}/lib")
      file(COPY_FILE "${compiler_dir}/lib/pkgconfig/openmp.pc" "${CURRENT_PACKAGES_DIR}/lib/pkgconfig/libiomp5.pc")
      vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/lib/pkgconfig/libiomp5.pc" "/windows/compiler/lib/intel64_win/" "/lib/")
      ...
      if(NOT VCPKG_BUILD_TYPE)
        ...
        file(COPY "${compiler_dir}/windows/compiler/lib/intel64_win/" DESTINATION "${CURRENT_PACKAGES_DIR}/debug/lib")
      endif()
    endif()
else()
...
if(VCPKG_TARGET_IS_WINDOWS)
    file(GLOB all_pc_files "${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/*.pc" "${CURRENT_PACKAGES_DIR}/lib/pkgconfig/*.pc")
    foreach(file IN LISTS all_pc_files)
        vcpkg_replace_string("${file}" "/lib/intel64" "/lib")
    endforeach()
endif()

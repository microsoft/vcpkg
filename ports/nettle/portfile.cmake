if(VCPKG_TARGET_IS_WINDOWS AND NOT VCPKG_TARGET_IS_MINGW)
    set(patches yasm.patch      # the asm changes are a downgrade to an older version
                compile.patch
...
if(VCPKG_TARGET_IS_WINDOWS AND NOT VCPKG_TARGET_IS_MINGW)
    if (VCPKG_LIBRARY_LINKAGE STREQUAL dynamic)
        ...
        configure_file("${CURRENT_PORT_DIR}/nettle-${VCPKG_TARGET_ARCHITECTURE}.def"  "${build_dir}/nettle.def" COPYONLY)
        configure_file("${CURRENT_PORT_DIR}/hogweed-${VCPKG_TARGET_ARCHITECTURE}.def"  "${build_dir}/hogweed.def" COPYONLY)
        if(NOT VCPKG_BUILD_TYPE)

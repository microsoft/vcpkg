...
if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "release")
    if(WIN32 AND VCPKG_LIBRARY_LINKAGE STREQUAL "dynamic")
        list(APPEND REL_BIN_FILES
            "${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-rel/lib/elements.dll"
            "${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-rel/lib/elements.pdb"
        )
        file(INSTALL ${REL_BIN_FILES} DESTINATION "${CURRENT_PACKAGES_DIR}/bin")
    else()
...
if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "debug")
    if(WIN32 AND VCPKG_LIBRARY_LINKAGE STREQUAL "dynamic")
        list(APPEND DBG_BIN_FILES
            "${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-dbg/lib/elements.dll"
            "${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-dbg/lib/elements.pdb"
        )
        file(INSTALL ${DBG_BIN_FILES} DESTINATION "${CURRENT_PACKAGES_DIR}/debug/bin")
    else()

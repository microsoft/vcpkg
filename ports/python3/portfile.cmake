...
if (VCPKG_TARGET_IS_WINDOWS)
	...
	file(GLOB RUNTIMES "${CURRENT_PACKAGES_DIR}/bin/vcruntime*" "${CURRENT_PACKAGES_DIR}/debug/bin/vcruntime*")
	if(RUNTIMES)
		file(REMOVE ${RUNTIMES})
		file(GLOB BINS "${CURRENT_PACKAGES_DIR}/bin/*" "${CURRENT_PACKAGES_DIR}/debug/bin/*")
		if(NOT BINS)
			file(REMOVE_RECURSE "${CURRENT_PACKAGES_DIR}/bin" "${CURRENT_PACKAGES_DIR}/debug/bin")
		endif()
	endif()
	file(MAKE_DIRECTORY ${CURRENT_PACKAGES_DIR}/share/python${PYTHON_VERSION_MAJOR})
	file(RENAME
			"${SOURCE_PATH}/Lib"
			"${CURRENT_PACKAGES_DIR}/share/python${PYTHON_VERSION_MAJOR}/Lib"
	)

...
set(PATCHES
    ${PATCHES}
    0002-always-use-vcpkg-zlib.patch
    0003-remove-external-dependencies.patch
    0004-don-t-copy-vcruntime.patch
...
vcpkg_from_github(
    ...
    SHA512 4aadc06950b8afa217a98c6988cc2f354171f559fb598b521dc5fb6122050a340b48c05bae6548b9614165921238c73a846ba35fbef005f4f13c7b4b3b9c34ee
    HEAD_REF master
    PATCHES ${PATCHES}
)

if(VCPKG_TARGET_IS_WINDOWS OR VCPKG_TARGET_IS_UWP)
    # Here is your official warning: *shared* C extension modules can only be used on dynamic python on Windows.
    if(VCPKG_LIBRARY_LINKAGE STREQUAL "dynamic")
        set(PYTHON_ALLOW_EXTENSIONS ON)
    else()
        message(STATUS "WARNING: Static builds of Python should only be used for embedding.")
    endif()
    ...
    if(PYTHON_ALLOW_EXTENSIONS)
        ...
        find_library(LZMA_DEBUG NAMES lzma lzmad PATHS "${CURRENT_INSTALLED_DIR}/debug/lib" NO_DEFAULT_PATH)
    ...
    # Remove any extemsopm libraries and other unversioned binaries that could conflict with the python2 port.
    ...
    list(FILTER PYTHON_LIB_DIRS INCLUDE REGEX [[config-[0-9].[0-9].*]])
...
generate_finder(DIRECTORY "python" PREFIX "Python" NEW_FINDER LIBS INTERP)
generate_finder(DIRECTORY "python3" PREFIX "Python3" NEW_FINDER LIBS INTERP)
# Deprecated (but still used) find modules
generate_finder(DIRECTORY "pythoninterp" PREFIX "PYTHON" INTERP)
generate_finder(DIRECTORY "pythonlibs" PREFIX "PYTHON" LIBS)

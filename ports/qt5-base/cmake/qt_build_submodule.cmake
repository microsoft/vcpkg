...
function(qt_build_submodule SOURCE_PATH)
    ...
    if(EXISTS "${CURRENT_PACKAGES_DIR}/tools/qt5/bin")
        ...
        if(VCPKG_TARGET_IS_WINDOWS)
            ...
            message(STATUS "FOUND DLLS: ${DLL_DEPS_AVAIL}")
            ...
            message(STATUS "DEP DLLS: ${DLL_DEPS_NEEDED}")
            if(DLL_DEPS_AVAIL AND DLL_DEPS_NEEDED)
                list(REMOVE_ITEM DLL_DEPS_NEEDED ${DLL_DEPS_AVAIL})
            endif()
            message(STATUS "NEEDED DLLS: ${DLL_DEPS_NEEDED}")
            foreach(dll_dep ${DLL_DEPS_NEEDED})
                file(COPY "${CURRENT_PACKAGES_DIR}/tools/${PORT}/bin/${dll_dep}" DESTINATION "${CURRENT_PACKAGES_DIR}/tools/qt5/bin")
            endforeach()
        endif()
    endif()
endfunction()
...
function(qt_fix_makefile_install BUILD_DIR)
    ...
    get_filename_component(NATIVE_INSTALLED_DIR "${CURRENT_INSTALLED_DIR}" ABSOLUTE)
    get_filename_component(NATIVE_PACKAGES_DIR "${CURRENT_PACKAGES_DIR}" ABSOLUTE)

    file(TO_NATIVE_PATH "${NATIVE_INSTALLED_DIR}" NATIVE_INSTALLED_DIR)
    file(TO_NATIVE_PATH "${NATIVE_PACKAGES_DIR}" NATIVE_PACKAGES_DIR)

...
function(qt_fix_makefile_install BUILD_DIR)
    ...
    foreach(MAKEFILE ${MAKEFILES})
        ...
        if(VCPKG_TARGET_IS_MINGW)
            string(REPLACE "${INSTALLED_DRIVE}$(INSTALL_ROOT:@msyshack@%=%)${INSTALLED_DIR_WITHOUT_DRIVE}" "${PACKAGES_DRIVE}$(INSTALL_ROOT:@msyshack@%=%)${PACKAGES_DIR_WITHOUT_DRIVE}" _contents "${_contents}")
        else()

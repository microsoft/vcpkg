function(configure_qt)
    ...
    foreach(_buildname ${BUILDTYPES})
        ...
        string(REPLACE "${CMAKE_CURRENT_PACKAGES_DIR_PATH}" "\${CURRENT_PACKAGES_DIR}" _contents ${_contents})
        string(REPLACE "HostPrefix=\${CURRENT_PACKAGES_DIR}" "\${CURRENT_INSTALLED_DIR}" _contents ${_contents})

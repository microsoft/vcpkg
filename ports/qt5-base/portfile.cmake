...
[[    set_target_properties(Qt5::WinMain PROPERTIES
    ...
    if(EXISTS ${CURRENT_PACKAGES_DIR}/tools/qt5/bin)
        ...
        vcpkg_copy_tool_dependencies(TOOL_DIR ${CURRENT_PACKAGES_DIR}/tools/qt5/bin)
    endif()
    ...
    if(EXISTS ${CURRENT_PACKAGES_DIR}/debug/tools/qt5/bin)
        ...
        vcpkg_copy_tool_dependencies(TOOL_DIR ${CURRENT_PACKAGES_DIR}/tools/qt5/debug/bin)
    endif()

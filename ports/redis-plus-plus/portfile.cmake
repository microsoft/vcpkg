...
if ("async-std" IN_LIST FEATURES AND "async-boost" IN_LIST FEATURES)
    message(FATAL_ERROR "Cannot enable both async-std and async-boost features at the same time.")
elseif ("async-std" IN_LIST FEATURES)
    list(APPEND EXTRA_OPT "-DREDIS_PLUS_PLUS_ASYNC_FUTURE=std")
elseif ("async-boost" IN_LIST FEATURES)
    list(APPEND EXTRA_OPT "-DREDIS_PLUS_PLUS_ASYNC_FUTURE=boost")
endif()

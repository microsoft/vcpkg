if (VCPKG_LIBRARY_LINKAGE STREQUAL "static")
    set(DISABLE_STB_IMPLEMENTATION TRUE)
endif()
...
if ("test-engine" IN_LIST FEATURES)
    ...
    if (DISABLE_STB_IMPLEMENTATION)
        vcpkg_replace_string("${SOURCE_PATH}/test-engine/imgui_capture_tool.cpp" "//#define IMGUI_DISABLE_STB_IMAGE_WRITE_IMPLEMENTATION" "#define IMGUI_DISABLE_STB_IMAGE_WRITE_IMPLEMENTATION")
    endif()

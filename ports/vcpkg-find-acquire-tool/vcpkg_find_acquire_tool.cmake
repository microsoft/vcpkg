...
function(vcpkg_find_acquire_tool)
    ...
    if(NOT out_tool_path)
        ...
        if(NOT DEFINED arg_URLS)
            ...
            if(CMAKE_HOST_WIN32)
                set(message "Could not find ${arg_TOOL_NAME}, please install it.")
            else()
                set(message "Could not find ${arg_TOOL_NAME}, please install it via your system package manager.")
            endif()
            ...
            foreach(system_manager IN ITEMS brew apt dnf zypper apk)
                ...
                if(DEFINED arg_${SYSTEM_MANAGER}_PACKAGE_NAME)
                    ...
                    if(${SYSTEM_MANAGER})
                        string(APPEND message "\nFor example:\n    ${system_manager} install ${arg_${SYSTEM_MANAGER}_PACKAGE_NAME}")
                    endif()
                endif()
            endforeach()
            ...
            if(DEFINED arg_APT_PACKAGE_NAME AND NOT APT)
                ...
                if(APT_GET)
                    string(APPEND message "\nFor example:\n    apt-get install ${arg_APT_PACKAGE_NAME}")
                endif()
            endif()
            ...
            if(DEFINED arg_DNF_PACKAGE_NAME AND NOT DNF)
                ...
                if(YUM)
                    string(APPEND message "\nFor example:\n    yum install ${arg_DNF_PACKAGE_NAME}")
                endif()
            endif()

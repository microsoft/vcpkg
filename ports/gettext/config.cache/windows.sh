...
ac_cv_sys_file_offset_bits=${ac_cv_sys_file_offset_bits=unknown}
ac_cv_sys_large_files=${ac_cv_sys_large_files=unknown}
ac_cv_sys_largefile_CC=${ac_cv_sys_largefile_CC=no}
ac_cv_sys_largefile_source=${ac_cv_sys_largefile_source=unknown}
...
acl_cv_hardcode_libdir_flag_spec=${acl_cv_hardcode_libdir_flag_spec=' '}
...
acl_cv_libext=${acl_cv_libext=lib}
...
acl_cv_prog_gnu_ld=${acl_cv_prog_gnu_ld=no}
...
gl_cv_cc_long_double_expbit0=${gl_cv_cc_long_double_expbit0='word 1 bit 20'}
gl_cv_cc_wallow=${gl_cv_cc_wallow=none}
gl_cv_compiler_check_decl_option=${gl_cv_compiler_check_decl_option=none}
gl_cv_compiler_clang=${gl_cv_compiler_clang=no}
gl_cv_const_PTHREAD_CREATE_DETACHED=${gl_cv_const_PTHREAD_CREATE_DETACHED=no}
gl_cv_const_PTHREAD_MUTEX_RECURSIVE=${gl_cv_const_PTHREAD_MUTEX_RECURSIVE=no}
gl_cv_const_PTHREAD_MUTEX_ROBUST=${gl_cv_const_PTHREAD_MUTEX_ROBUST=no}
gl_cv_const_PTHREAD_PROCESS_SHARED=${gl_cv_const_PTHREAD_PROCESS_SHARED=no}
gl_cv_cxx_wallow=${gl_cv_cxx_wallow=none}
...
gl_cv_func_fopen_mode_x=${gl_cv_func_fopen_mode_x=yes}
...
gl_cv_func_fseeko=${gl_cv_func_fseeko=no}
gl_cv_func_ftello=${gl_cv_func_ftello=no}
...
gl_cv_func_getpagesize=${gl_cv_func_getpagesize=no}
gl_cv_func_isinfl_works=${gl_cv_func_isinfl_works=no}
gl_cv_func_isnand_no_libm=${gl_cv_func_isnand_no_libm=yes}
gl_cv_func_isnanf_no_libm=${gl_cv_func_isnanf_no_libm=yes}
gl_cv_func_isnanf_works=${gl_cv_func_isnanf_works=no}
gl_cv_func_isnanl_no_libm=${gl_cv_func_isnanl_no_libm=yes}
gl_cv_func_isnanl_works=${gl_cv_func_isnanl_works=no}
...
gl_cv_func_mbrtowc_empty_input=${gl_cv_func_mbrtowc_empty_input=no}
...
gl_cv_func_mbrtowc_null_arg1=${gl_cv_func_mbrtowc_null_arg1=yes}
gl_cv_func_mbrtowc_null_arg2=${gl_cv_func_mbrtowc_null_arg2=yes}
...
gl_cv_func_mbrtowc_stores_incomplete=${gl_cv_func_mbrtowc_stores_incomplete=yes}
...
gl_cv_func_printf_attribute_flavor=${gl_cv_func_printf_attribute_flavor=system}
...
gl_cv_func_printf_flag_grouping=${gl_cv_func_printf_flag_grouping=no}
...
gl_cv_func_pthread_sigmask_macro=${gl_cv_func_pthread_sigmask_macro=no}
...
gl_cv_func_signbit_builtins=${gl_cv_func_signbit_builtins=no}
...
gl_cv_func_timespec_get=${gl_cv_func_timespec_get=yes}
...
gl_cv_func_wcrtomb_retval=${gl_cv_func_wcrtomb_retval=no}
...
gl_cv_have_include_next=${gl_cv_have_include_next=no}
...
gl_cv_header_working_stdalign_h=${gl_cv_header_working_stdalign_h=no}
...
gl_cv_time_h_has_TIME_UTC=${gl_cv_time_h_has_TIME_UTC=yes}
gl_cv_type_max_align_t=${gl_cv_type_max_align_t=no}
gl_cv_type_off_t_64=${gl_cv_type_off_t_64=no}
...
gt_cv_ssize_t=${gt_cv_ssize_t=no}

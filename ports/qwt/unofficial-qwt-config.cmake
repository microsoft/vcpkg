if(NOT TARGET unofficial::qwt::qwt)
    ...
    if(EXISTS "${qwt_LIBRARY_RELEASE_DLL}")
        ...
        if(EXISTS "${qwt_LIBRARY_DEBUG_DLL}")
            ...
            find_library(qwt_LIBRARY_DEBUG NAMES qwt PATHS "${_VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}/debug/lib" NO_DEFAULT_PATH REQUIRED)
        ...
        find_library(qwt_LIBRARY_RELEASE NAMES qwtd PATHS "${_VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}/lib" NO_DEFAULT_PATH)

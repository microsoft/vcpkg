...
if(VCPKG_TARGET_IS_WINDOWS)
    ...
    foreach(module IN ITEMS mpi-c.pc mpi-cxx.pc)
    ...
    endforeach()
    if(EXISTS "${CURRENT_INSTALLED_DIR}/lib/pkgconfig/ompi-fort.pc")
        file(COPY_FILE "${CURRENT_INSTALLED_DIR}/lib/pkgconfig/ompi-fort.pc" "${CURRENT_PACKAGES_DIR}/lib/pkgconfig/mpi-fort.pc")
        if(EXISTS "${CURRENT_INSTALLED_DIR}/debug/lib/pkgconfig/ompi-fort.pc")
            file(MAKE_DIRECTORY "${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig")
            file(COPY_FILE "${CURRENT_INSTALLED_DIR}/debug/lib/pkgconfig/ompi-fort.pc" "${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/mpi-fort.pc")
        endif()
    endif()
endif()

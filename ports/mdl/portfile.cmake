...
elseif(VCPKG_TARGET_IS_LINUX)
    if (VCPKG_TARGET_ARCHITECTURE STREQUAL x64)
        set(LLVM_DIRECTORY "${DOWNLOADS}/tools/llvm-${LLVM_VERSION}/x86_64-linux-gnu-ubuntu-16.04")
...
elseif(VCPKG_TARGET_IS_FREEBSD)
    if (VCPKG_TARGET_ARCHITECTURE STREQUAL x64)
        set(LLVM_DIRECTORY "${DOWNLOADS}/tools/llvm-${LLVM_VERSION}/amd64-unknown-freebsd11")
...
elseif(VCPKG_TARGET_IS_OSX)
    if (VCPKG_TARGET_ARCHITECTURE STREQUAL x64)
        set(LLVM_DIRECTORY "${DOWNLOADS}/tools/llvm-${LLVM_VERSION}/x86_64-apple-darwin")
...
set(CLANG7 "${LLVM_DIRECTORY}/bin/clang${VCPKG_TARGET_EXECUTABLE_SUFFIX}")
if(NOT EXISTS "${CLANG7}")

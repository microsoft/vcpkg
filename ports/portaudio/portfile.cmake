...
if (VCPKG_CRT_LINKAGE STREQUAL dynamic)
	...
	file (RENAME ${CURRENT_PACKAGES_DIR}/bin/portaudio_${VCPKG_TARGET_ARCHITECTURE}.dll ${CURRENT_PACKAGES_DIR}/bin/portaudio.dll)
	...
	file (RENAME ${CURRENT_PACKAGES_DIR}/debug/bin/portaudio_${VCPKG_TARGET_ARCHITECTURE}.dll ${CURRENT_PACKAGES_DIR}/debug/bin/portaudio.dll)
else ()

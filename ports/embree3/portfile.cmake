...
# Fix QuadraticBezierCurve operator<< to remove non-existent u member
file(READ "${SOURCE_PATH}/kernels/subdiv/bezier_curve.h" BEZIER_CURVE_CONTENT)
string(REPLACE "return cout << \"QuadraticBezierCurve ( (\" << a.u.lower << \", \" << a.u.upper << \"), \" << a.v0 << \", \" << a.v1 << \", \" << a.v2 << \")\";" "return cout << \"QuadraticBezierCurve (\" << a.v0 << \", \" << a.v1 << \", \" << a.v2 << \")\";" BEZIER_CURVE_CONTENT "${BEZIER_CURVE_CONTENT}")
file(WRITE "${SOURCE_PATH}/kernels/subdiv/bezier_curve.h" "${BEZIER_CURVE_CONTENT}")

# Fix PointMi operator<< to remove non-existent v0 member
file(READ "${SOURCE_PATH}/kernels/geometry/pointi.h" POINTI_CONTENT)
string(REPLACE "return cout << \"Line\" << M << \"i {\" << line.v0 << \", \" << line.geomID() << \", \" << line.primID() << \"}\";" "return cout << \"Line\" << M << \"i {\" << line.geomID() << \", \" << line.primID() << \"}\";" POINTI_CONTENT "${POINTI_CONTENT}")
file(WRITE "${SOURCE_PATH}/kernels/geometry/pointi.h" "${POINTI_CONTENT}")
...
elif(VCPKG_TARGET_IS_OSX AND (VCPKG_TARGET_ARCHITECTURE STREQUAL "arm64"))

...
file(INSTALL ${SOURCE_PATH}/LICENSES/GPL-2.0-or-later.txt DESTINATION ${CURRENT_PACKAGES_DIR}/share/${PORT} RENAME copyright-GPL-2.0-or-later)
file(INSTALL ${SOURCE_PATH}/LICENSES/LGPL-2.0-or-later.txt DESTINATION ${CURRENT_PACKAGES_DIR}/share/${PORT} RENAME copyright-LGPL-2.0-or-later)

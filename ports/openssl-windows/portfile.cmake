...
if(EXISTS "${CURRENT_PACKAGES_DIR}/debug/lib/libeay32.lib")
    file(RENAME "${CURRENT_PACKAGES_DIR}/debug/lib/libeay32.lib" "${CURRENT_PACKAGES_DIR}/debug/lib/libeay32d.lib")
endif()
if(EXISTS "${CURRENT_PACKAGES_DIR}/debug/lib/eay32.lib")
    file(RENAME "${CURRENT_PACKAGES_DIR}/debug/lib/eay32.lib" "${CURRENT_PACKAGES_DIR}/debug/lib/eay32d.lib")
endif()
if(EXISTS "${CURRENT_PACKAGES_DIR}/debug/lib/ssleay32.lib")
    file(RENAME "${CURRENT_PACKAGES_DIR}/debug/lib/ssleay32.lib" "${CURRENT_PACKAGES_DIR}/debug/lib/ssleay32d.lib")
endif()
if(EXISTS "${CURRENT_PACKAGES_DIR}/debug/lib/ssl.lib")
    file(RENAME "${CURRENT_PACKAGES_DIR}/debug/lib/ssl.lib" "${CURRENT_PACKAGES_DIR}/debug/lib/ssld.lib")
endif()
if(EXISTS "${CURRENT_PACKAGES_DIR}/debug/lib/crypto.lib")
    file(RENAME "${CURRENT_PACKAGES_DIR}/debug/lib/crypto.lib" "${CURRENT_PACKAGES_DIR}/debug/lib/cryptod.lib")
endif()
if(EXISTS "${CURRENT_PACKAGES_DIR}/debug/lib/libcrypto.lib")
    file(RENAME "${CURRENT_PACKAGES_DIR}/debug/lib/libcrypto.lib" "${CURRENT_PACKAGES_DIR}/debug/lib/libcryptod.lib")
endif()

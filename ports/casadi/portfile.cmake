...
vcpkg_from_github(
    ...
    HEAD_REF main
    PATCHES relocatable.patch disable_fortran.patch cmake_paths.cmake
)
...
vcpkg_cmake_configure(
    ...
    OPTIONS
     ...
     -DWITH_SUNDIALS=OFF
     -DWITH_CSPARSE=OFF
     -DLIB_PREFIX_RELATIVE=lib
     -DBIN_PREFIX_RELATIVE=bin
     -DINCLUDE_PREFIX_RELATIVE=include
     -DCMAKE_PREFIX_RELATIVE=share/${PORT}
)

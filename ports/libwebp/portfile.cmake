...
if("cwebp" IN_LIST FEATURES)
  vcpkg_copy_tools(TOOL_NAMES cwebp DESTINATION "${CURRENT_PACKAGES_DIR}/tools/webp"  AUTO_CLEAN)
endif()
if("dwebp" IN_LIST FEATURES)
  vcpkg_copy_tools(TOOL_NAMES dwebp DESTINATION "${CURRENT_PACKAGES_DIR}/tools/webp"  AUTO_CLEAN)
endif()
if("gif2webp" IN_LIST FEATURES)
  vcpkg_copy_tools(TOOL_NAMES gif2webp DESTINATION "${CURRENT_PACKAGES_DIR}/tools/webp"  AUTO_CLEAN)
endif()
if("img2webp" IN_LIST FEATURES)
  vcpkg_copy_tools(TOOL_NAMES img2webp DESTINATION "${CURRENT_PACKAGES_DIR}/tools/webp"  AUTO_CLEAN)
endif()
if("vwebp" IN_LIST FEATURES)
  vcpkg_copy_tools(TOOL_NAMES vwebp DESTINATION "${CURRENT_PACKAGES_DIR}/tools/webp"  AUTO_CLEAN)
endif()
if("info" IN_LIST FEATURES)
  vcpkg_copy_tools(TOOL_NAMES webpinfo DESTINATION "${CURRENT_PACKAGES_DIR}/tools/webp"  AUTO_CLEAN)
endif()
if("mux" IN_LIST FEATURES)
  vcpkg_copy_tools(TOOL_NAMES webpmux DESTINATION "${CURRENT_PACKAGES_DIR}/tools/webp"  AUTO_CLEAN)
endif()

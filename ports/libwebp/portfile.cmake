...
if("info" IN_LIST FEATURES)
  list(APPEND BUILD_ONLY webpinfo)
endif()
if("mux" IN_LIST FEATURES)
  list(APPEND BUILD_ONLY webpmux)
endif()

vcpkg_copy_tools(TOOL_NAMES ${BUILD_ONLY} DESTINATION "${CURRENT_PACKAGES_DIR}/tools/webp"  AUTO_CLEAN)

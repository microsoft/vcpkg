function(boost_modular_build)
    ...
    set(REQUIRED_TRIPLET "")
    if(CMAKE_HOST_WIN32)
        get_filename_component(BOOST_BUILD_PATH "${CURRENT_INSTALLED_DIR}/../x86-windows/tools/boost-build" ABSOLUTE)
        set(REQUIRED_TRIPLET "x86-windows")
    elseif(CMAKE_HOST_APPLE)
        get_filename_component(BOOST_BUILD_PATH "${CURRENT_INSTALLED_DIR}/../x64-osx/tools/boost-build" ABSOLUTE)
		set(REQUIRED_TRIPLET "x64-osx")
    elseif(CMAKE_HOST_SYSTEM_NAME STREQUAL "Linux")
        get_filename_component(BOOST_BUILD_PATH "${CURRENT_INSTALLED_DIR}/../x64-linux/tools/boost-build" ABSOLUTE)
		set(REQUIRED_TRIPLET "x64-linux")
    else()
        set(BOOST_BUILD_PATH "${CURRENT_INSTALLED_DIR}/tools/boost-build")
    endif()

    if(NOT EXISTS "${BOOST_BUILD_PATH}")
        message(FATAL_ERROR "The host boost-build tools must be installed to build for non-x86/x64 platforms. Please run `vcpkg install boost-build:${REQUIRED_TRIPLET}`.")
    endif()

...
function(boost_modular_build)
    ...
    if(VCPKG_CMAKE_SYSTEM_NAME STREQUAL "WindowsStore")
        ...
        set(TOOLSET_OPTIONS "${TOOLSET_OPTIONS} <cflags>-Zl <compileflags> /AI\"${PLATFORM_WINMD_DIR}\" <cxxflags>/ZW <compileflags>-DVirtualAlloc=VirtualAllocFromApp <compileflags>-D_WIN32_WINNT=0x0A00")
    endif()

    if(VCPKG_TARGET_IS_UWP)
        list(APPEND B2_OPTIONS "linkflags=WindowsApp.lib")
        list(APPEND B2_OPTIONS "linkflags=/APPCONTAINER")
    endif()

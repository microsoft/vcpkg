...
if("gles-api-latest" IN_LIST FEATURES)
    LIST(APPEND GLAD_API "gles=")
elseif("gles-api-10" IN_LIST FEATURES)
    LIST(APPEND GLAD_API "gles=1.0")
endif()
...
if("glsc2-api-latest" IN_LIST FEATURES)
    LIST(APPEND GLAD_API "glsc=")
elseif("glsc2-api-20" IN_LIST FEATURES)
    LIST(APPEND GLAD_API "glsc=2.0")
endif()

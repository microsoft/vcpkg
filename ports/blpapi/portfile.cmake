...
if ("${VCPKG_TARGET_ARCHITECTURE}" MATCHES "x86")
    if (VCPKG_TARGET_IS_LINUX)
        file(GLOB SO_FILES LIST_DIRECTORIES false "${SOURCE_PATH}/Linux/*32.so")
    else()
        file(GLOB DLL_FILES LIST_DIRECTORIES false "${SOURCE_PATH}/lib/*32.dll")
        file(GLOB LIB_FILES LIST_DIRECTORIES false "${SOURCE_PATH}/lib/*32.lib")
    endif()
elseif ("${VCPKG_TARGET_ARCHITECTURE}" MATCHES "x64")
    if(VCPKG_TARGET_IS_LINUX)
        file(GLOB SO_FILES LIST_DIRECTORIES false "${SOURCE_PATH}/Linux/*64.so")
    else()
        file(GLOB DLL_FILES LIST_DIRECTORIES false "${SOURCE_PATH}/lib/*64.dll")
        file(GLOB LIB_FILES LIST_DIRECTORIES false "${SOURCE_PATH}/lib/*64.lib")
    endif()
endif()

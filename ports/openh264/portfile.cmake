...
file(INSTALL "${CURRENT_PORT_DIR}/OpenH264Config.cmake" DESTINATION "${CURRENT_PACKAGES_DIR}/share/${PORT}")
vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/share/${PORT}/OpenH264Config.cmake" "OPENH264_VERSION_PLACEHOLDER" "${VERSION}")

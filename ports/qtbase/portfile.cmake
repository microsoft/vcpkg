...
if(EXISTS "${CURRENT_PACKAGES_DIR}/bin")    
    ...
    foreach(script IN LISTS script_files)
        if(EXISTS "${CURRENT_PACKAGES_DIR}/bin/${script}${script_suffix}")
            set(target_script "${CURRENT_PACKAGES_DIR}/tools/Qt6/bin/${script}${script_suffix}")
            file(RENAME "${CURRENT_PACKAGES_DIR}/bin/${script}${script_suffix}" "${target_script}")
    ...
    foreach(other IN LISTS other_files)
        if(EXISTS "${CURRENT_PACKAGES_DIR}/bin/${other}")
            file(RENAME "${CURRENT_PACKAGES_DIR}/bin/${other}" "${CURRENT_PACKAGES_DIR}/tools/Qt6/bin/${other}")
        endif()
    endforeach()
endif()

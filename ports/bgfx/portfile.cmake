vcpkg_fail_port_install(ON_TARGET "WindowsStore" "Android" "FreeBSD")
...
if(VCPKG_TARGET_IS_WINDOWS)
  vcpkg_build_make(WORKING_DIRECTORY ${SOURCE_PATH})
  vcpkg_build_msbuild(PROJECT_PATH ${SOURCE_PATH}/.build/projects/vs2017/bgfx.sln PLATFORM ${MSBUILD_PLATFORM})
else()
  vcpkg_build_make(WORKING_DIRECTORY ${SOURCE_PATH} RELEASE_TARGET ${MAKE_TARGET_REL} DEBUG_TARGET ${MAKE_TARGET_DBG})
endif()
...
# Install files
file(COPY ${SOURCE_PATH}/include/bgfx
          ${BIMG_SOURCE_DIR}/include/bimg
          ${BX_SOURCE_DIR}/include/bx
          ${BX_SOURCE_DIR}/include/compat
          ${BX_SOURCE_DIR}/include/tinystl
...
file(COPY ${SHADERC_RELEASE} ${TEXTUREC_RELEASE} ${GEOMETRYC_RELEASE} DESTINATION ${CURRENT_PACKAGES_DIR}/tools)
file(COPY ${SHADERC_DEBUG} ${TEXTUREC_DEBUG} ${GEOMETRYC_DEBUG} DESTINATION ${CURRENT_PACKAGES_DIR}/debug/tools)

...
if(VCPKG_TARGET_ARCHITECTURE STREQUAL "x64")
  ...
  set(MSBUILD_CONFIGURATION "x64")
elseif(VCPKG_TARGET_ARCHITECTURE STREQUAL "x86")
  set(MAKE_TARGET_ARCH 32)
  set(MSBUILD_CONFIGURATION "Win32")
endif()
...
if(VCPKG_TARGET_IS_WINDOWS)
  ...
  vcpkg_build_msbuild(
    PROJECT_PATH ${BGFX_SOURCE_DIR}/.build/projects/vs2017/bgfx.sln
    RELEASE_CONFIGURATION "Release|${MSBUILD_CONFIGURATION}"
    DEBUG_CONFIGURATION   "Debug|${MSBUILD_CONFIGURATION}"
  )
else()

...
if(NOT VCPKG_CMAKE_SYSTEM_NAME OR VCPKG_CMAKE_SYSTEM_NAME STREQUAL "WindowsStore")
    ...
    file(COPY ${CMAKE_CURRENT_LIST_DIR}/glcorearb.h DESTINATION ${CURRENT_PACKAGES_DIR}/include/gl)
    file(COPY ${CMAKE_CURRENT_LIST_DIR}/glext.h DESTINATION ${CURRENT_PACKAGES_DIR}/include/gl)
    file(COPY ${CMAKE_CURRENT_LIST_DIR}/glxext.h DESTINATION ${CURRENT_PACKAGES_DIR}/include/gl)
    file(COPY ${CMAKE_CURRENT_LIST_DIR}/wgl.h DESTINATION ${CURRENT_PACKAGES_DIR}/include/gl)
    file(COPY ${CMAKE_CURRENT_LIST_DIR}/wglext.h DESTINATION ${CURRENT_PACKAGES_DIR}/include/gl)

...
if(VCPKG_TARGET_IS_WINDOWS OR VCPKG_TARGET_IS_UWP)
    set(LIB_NAME_DEBUG "libhpdfsd")
else()
    set(LIB_NAME_DEBUG "libhpdfs")
endif()
...
if(VCPKG_LIBRARY_LINKAGE STREQUAL "static")
    ...
    if(NOT VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "debug")
        file(RENAME "${CURRENT_PACKAGES_DIR}/debug/lib/${LIB_NAME_DEBUG}${VCPKG_TARGET_STATIC_LIBRARY_SUFFIX}" "${CURRENT_PACKAGES_DIR}/debug/lib/libhpdfd${VCPKG_TARGET_STATIC_LIBRARY_SUFFIX}")
    endif()
endif()

...
string(REPLACE "typedef HPDF_HANDLE HPDF_Image;" "" _contents "${_contents}")
string(REPLACE "typedef HPDF_HANDLE HPDF_Outline;" "" _contents "${_contents}")
string(REPLACE "typedef HPDF_HANDLE HPDF_Encoder;" "" _contents "${_contents}")
string(REPLACE "typedef HPDF_HANDLE HPDF_3DMeasure;" "" _contents "${_contents}")
string(REPLACE "typedef HPDF_HANDLE HPDF_ExData;" "" _contents "${_contents}")
string(REPLACE "typedef HPDF_HANDLE HPDF_Destination;" "" _contents "${_contents}")
string(REPLACE "typedef HPDF_HANDLE HPDF_XObject;" "" _contents "${_contents}")
string(REPLACE "typedef HPDF_HANDLE HPDF_Annotation;" "" _contents "${_contents}")
string(REPLACE "typedef HPDF_HANDLE HPDF_ExtGState;" "" _contents "${_contents}")
string(REPLACE "typedef HPDF_HANDLE HPDF_U3D;" "" _contents "${_contents}")
string(REPLACE "typedef HPDF_HANDLE HPDF_JavaScript;" "" _contents "${_contents}")
string(REPLACE "typedef HPDF_HANDLE HPDF_Error;" "" _contents "${_contents}")
string(REPLACE "typedef HPDF_HANDLE HPDF_MMgr;" "" _contents "${_contents}")
string(REPLACE "typedef HPDF_HANDLE HPDF_Dict;" "" _contents "${_contents}")
string(REPLACE "typedef HPDF_HANDLE HPDF_EmbeddedFile;" "" _contents "${_contents}")
string(REPLACE "typedef HPDF_HANDLE HPDF_OutputIntent;" "" _contents "${_contents}")
string(REPLACE "typedef HPDF_HANDLE HPDF_Xref;" "" _contents "${_contents}")

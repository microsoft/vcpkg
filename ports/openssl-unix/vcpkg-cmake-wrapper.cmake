...
message(STATUS "OPENSSL TEST: ${OPENSSL_FOUND}:${OPENSSL_CRYPTO_LIBRARY}:${LIB_EAY_LIBRARY_DEBUG}:${LIB_EAY_LIBRARY_RELEASE}")
if(OPENSSL_FOUND)
  message(STATUS "OPENSSL TEST start")
  if(NOT TARGET OpenSSL::Crypto AND
      (OPENSSL_CRYPTO_LIBRARY OR
        LIB_EAY_LIBRARY_DEBUG OR
        LIB_EAY_LIBRARY_RELEASE)
      )
    message(STATUS "OPENSSL TEST2")
    add_library(OpenSSL::Crypto UNKNOWN IMPORTED)
    set_target_properties(OpenSSL::Crypto PROPERTIES
      INTERFACE_INCLUDE_DIRECTORIES "${OPENSSL_INCLUDE_DIR}")
    if(OPENSSL_CRYPTO_LIBRARY)
      message(STATUS "OPENSSL TEST3")
      set_target_properties(OpenSSL::Crypto PROPERTIES
        IMPORTED_LINK_INTERFACE_LANGUAGES "C"
        IMPORTED_LOCATION "${OPENSSL_CRYPTO_LIBRARY}")
    endif()
    if(LIB_EAY_LIBRARY_RELEASE)
      message(STATUS "OPENSSL TEST4")

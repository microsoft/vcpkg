...
z_vcpkg_make_determine_target_triplet(build_opt_triplet COMPILER_NAME "${VCPKG_DETECTED_CMAKE_C_COMPILER}")
set(source "vcpkg")
if(NOT build_opt_triplet)
    ...
    if(NOT build_opt_triplet)
        message("${Z_VCPKG_BACKCOMPAT_MESSAGE_LEVEL}"
            ...
            "You may need to define VCPKG_MAKE_BUILD_TRIPLET in the triplet fiel."
        )
    endif()
    set(source "config.guess")
endif()
file(WRITE "${CURRENT_PACKAGES_DIR}/share/${PORT}/build_opt_triplet.txt" "${build_opt_triplet}")
message(STATUS "${TARGET_TRIPLET} autotools triplet: ${build_opt_triplet} (from ${source})")

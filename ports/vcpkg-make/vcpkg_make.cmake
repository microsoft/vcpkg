...
function(vcpkg_run_autoreconf shell_cmd work_dir)
    ...
    if(EXISTS "${work_dir}/configure.ac")
        ...
        if(configure_ac MATCHES "AM_GNU_GETTEXT" AND NOT "$ENV{AUTOPOINT}${AUTOPOINT}" STREQUAL "")
        ...
        if(configure_ac MATCHES "GTK_DOC_CHECK" AND NOT "$ENV{GTKDOCIZE}${GTKDOCIZE}" STREQUAL "")

...
function(z_vcpkg_make_determine_target_triplet out)
    ...
    set(output "")
    if(DEFINED VCPKG_MAKE_BUILD_TRIPLET AND VCPKG_MAKE_BUILD_TRIPLET MATCHES "--host=([^;]*)")

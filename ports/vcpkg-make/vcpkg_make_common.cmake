...
function(z_vcpkg_make_prepare_compile_flags)
    ...
    if(arg_COMPILER_FRONTEND STREQUAL "MSVC" AND VCPKG_TARGET_IS_UWP)
        list(REMOVE_ITEM CFLAGS "/WINMD:NO" "-WINMD:NO" "/winmd:no" "-winmd:no")
        list(REMOVE_ITEM CXXFLAGS "/WINMD:NO" "-WINMD:NO" "/winmd:no" "-winmd:no")
        list(REMOVE_ITEM LDFLAGS "/WINMD:NO" "-WINMD:NO" "/winmd:no" "-winmd:no")
    endif()
    ...
    if(arg_COMPILER_FRONTEND STREQUAL "MSVC")
        ...
        list(APPEND flags_out "LINK_ENV_${var_suffix}")
    endif()

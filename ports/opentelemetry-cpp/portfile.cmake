...
vcpkg_check_features(OUT_FEATURE_OPTIONS FEATURE_OPTIONS
    FEATURES
        ...
        stdlib-cxx14 WITH_STL_CXX14
        stdlib-cxx17 WITH_STL_CXX17
        stdlib-cxx20 WITH_STL_CXX20
        stdlib-cxx23 WITH_STL_CXX23
    INVERTED_FEATURES
...
if(WITH_STL_CXX14)
  list(APPEND FEATURE_OPTIONS -DWITH_STL=CXX14 -DCMAKE_CXX_STANDARD=14)
elseif(WITH_STL_CXX17)
  list(APPEND FEATURE_OPTIONS -DWITH_STL=CXX17 -DCMAKE_CXX_STANDARD=17)
elseif(WITH_STL_CXX20)
  list(APPEND FEATURE_OPTIONS -DWITH_STL=CXX20 -DCMAKE_CXX_STANDARD=20)
elseif(WITH_STL_CXX23)
  list(APPEND FEATURE_OPTIONS -DWITH_STL=CXX23 -DCMAKE_CXX_STANDARD=23)
else()

...
if (VCPKG_CMAKE_SYSTEM_NAME STREQUAL "Linux")
    if (EXISTS ${CURRENT_PACKAGES_DIR}/tools/qt5-declarative/qmlcachegen)
        file(RENAME ${CURRENT_PACKAGES_DIR}/tools/qt5-declarative/qmlcachegen ${CURRENT_PACKAGES_DIR}/tools/qt5/qmlcachegen)
    endif()
    if (EXISTS ${CURRENT_PACKAGES_DIR}/debug/tools/qt5-declarative/qmlimportscanner)
        file(RENAME ${CURRENT_PACKAGES_DIR}/debug/tools/qt5-declarative/qmlimportscanner ${CURRENT_PACKAGES_DIR}/debug/tools/qt5/qmlimportscanner)
    endif()
    if (EXISTS ${CURRENT_PACKAGES_DIR}/tools/qt5-declarative/qmlimportscanner)
        file(RENAME ${CURRENT_PACKAGES_DIR}/tools/qt5-declarative/qmlimportscanner ${CURRENT_PACKAGES_DIR}/tools/qt5/qmlimportscanner)
    endif()

...
function(vcpkg_cmake_configure)
    ...
    vcpkg_list(APPEND arg_OPTIONS_RELEASE "-DCMAKE_PKG_CONFIG_PC_PATH=${CURRENT_INSTALLED_DIR}/lib/pkgconfig")
    if(DEFINED VCPKG_CMAKE_CONFIGURE_OPTIONS_DEBUG)
        vcpkg_list(APPEND arg_OPTIONS_DEBUG ${VCPKG_CMAKE_CONFIGURE_OPTIONS_DEBUG})
    endif()
    vcpkg_list(APPEND arg_OPTIONS_DEBUG "-DCMAKE_PKG_CONFIG_PC_PATH=${CURRENT_INSTALLED_DIR}/debug/lib/pkgconfig")

...
if(VCPKG_LIBRARY_LINKAGE STREQUAL dynamic)
    foreach(LIBNAME glfw.lib libglfw.dylib libogg.so)
        if(EXISTS "${CURRENT_PACKAGES_DIR}/lib/${LIBNAME}" OR EXISTS "${CURRENT_INSTALLED_DIR}/debug/lib/${LIBNAME}")

            file(MAKE_DIRECTORY ${CURRENT_PACKAGES_DIR}/bin ${CURRENT_PACKAGES_DIR}/debug/bin)
            file(RENAME ${CURRENT_PACKAGES_DIR}/lib/${LIBNAME} ${CURRENT_PACKAGES_DIR}/bin/${LIBNAME})
            file(RENAME ${CURRENT_PACKAGES_DIR}/debug/lib/${LIBNAME} ${CURRENT_PACKAGES_DIR}/debug/bin/${LIBNAME})
            foreach(_conf release
                          debug)
                file(READ ${CURRENT_PACKAGES_DIR}/share/glfw3/glfw3Targets-${_conf}.cmake _contents)
                string(REPLACE "lib/${LIBNAME}" "bin/${LIBNAME}" _contents "${_contents}")

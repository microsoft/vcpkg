...
elseif(VCPKG_TARGET_IS_OSX)
  file(COPY "${SOURCE_PATH}/Libraries/Mac/XPLM.framework/XPLM" DESTINATION "${CURRENT_PACKAGES_DIR}/lib")
  file(COPY "${SOURCE_PATH}/Libraries/Mac/XPLM.framework/XPLM" DESTINATION "${CURRENT_PACKAGES_DIR}/debug/lib")
  file(COPY "${SOURCE_PATH}/Libraries/Mac/XPWidgets.framework/XPWidgets" DESTINATION "${CURRENT_PACKAGES_DIR}/lib")
  file(COPY "${SOURCE_PATH}/Libraries/Mac/XPWidgets.framework/XPWidgets" DESTINATION "${CURRENT_PACKAGES_DIR}/debug/lib")
else()
  file(COPY "${SOURCE_PATH}/Libraries/Lin/XPLM_64.so" DESTINATION "${CURRENT_PACKAGES_DIR}/lib")
  file(COPY "${SOURCE_PATH}/Libraries/Lin/XPLM_64.so" DESTINATION "${CURRENT_PACKAGES_DIR}/debug/lib")
  file(COPY "${SOURCE_PATH}/Libraries/Lin/XPWidgets_64.so" DESTINATION "${CURRENT_PACKAGES_DIR}/lib")
  file(COPY "${SOURCE_PATH}/Libraries/Lin/XPWidgets_64.so" DESTINATION "${CURRENT_PACKAGES_DIR}/debug/lib")
endif()

...
if(VCPKG_TARGET_IS_LINUX OR VCPKG_TARGET_IS_UWP)
    set(DISABLE_PACKAGES)
else()
    set(DISABLE_PACKAGES ZLIB GIF JPEG PNG TIFF)
endif()
...
vcpkg_check_features(
    ...
    FEATURES
        libvorbis SIMAGE_OGGVORBIS_SUPPORT
        libsndfile SIMAGE_LIBSNDFILE_SUPPORT
)

if(NOT "libvorbis" IN_LIST FEATURES)
    list(APPEND DISABLE_PACKAGES Ogg Vorbis OggVorbis)
endif()

if(NOT "libsndfile" IN_LIST FEATURES)
    list(APPEND DISABLE_PACKAGES Sndfile FLAC)
endif()

vcpkg_configure_cmake(
    SOURCE_PATH ${SOURCE_PATH}
    REQUIRE_ALL_PACKAGES
    DISABLE_PACKAGES Jasper Doxygen QuickTime Opus ${DISABLE_PACKAGES}
    PREFER_NINJA
    OPTIONS

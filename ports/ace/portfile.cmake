...
elseif(VCPKG_TARGET_IS_LINUX OR VCPKG_TARGET_IS_OSX)
  vcpkg_configure_make(SOURCE_PATH ${WORKING_DIR} SKIP_CONFIGURE)
  vcpkg_build_make()
endif()
...
function(install_tao_executables SOURCE_PATH EXE_FILE)
    ...
    if(EXISTS "${ACE_ROOT}/bin/${EXE_FILE}${EXECUTABLE_SUFFIX}")
        file(COPY ${ACE_ROOT}/bin/${EXE_FILE}${EXECUTABLE_SUFFIX} DESTINATION ${CURRENT_PACKAGES_DIR}/tools/${PORT})
    endif()
endfunction()
...
if (VCPKG_LIBRARY_LINKAGE STREQUAL dynamic)
    file(COPY ${ACE_ROOT}/lib/ACE${DLL_DEBUG_SUFFIX} DESTINATION ${CURRENT_PACKAGES_DIR}/tools/${PORT})
    if(BUILD_TAO)
        file(COPY ${ACE_ROOT}/lib/TAO_IDL_FE${DLL_DEBUG_SUFFIX} DESTINATION ${CURRENT_PACKAGES_DIR}/tools/${PORT})
        file(COPY ${ACE_ROOT}/lib/TAO_IDL_BE${DLL_DEBUG_SUFFIX} DESTINATION ${CURRENT_PACKAGES_DIR}/tools/${PORT})
    endif()
endif()

# Handle copyright
file(COPY ${ACE_ROOT}/COPYING DESTINATION ${CURRENT_PACKAGES_DIR}/share/${PORT}/)

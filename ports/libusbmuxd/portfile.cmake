...
if(VCPKG_TARGET_IS_WINDOWS)
    vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/lib/pkgconfig/libusbmuxd-2.0.pc" "-lusbmuxd" "-llibusbmuxd")
    if(NOT VCPKG_BUILD_TYPE)
        vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/libusbmuxd-2.0.pc" "-lusbmuxd" "-llibusbmuxd")
    endif()
endif()

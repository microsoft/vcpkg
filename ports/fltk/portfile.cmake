...
if(EXISTS "${CURRENT_PACKAGES_DIR}/bin/fltk-config")
    ...
    vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/tools/${PORT}/fltk-config" "${CURRENT_INSTALLED_DIR}" "`dirname $0`/../..")
    if(NOT VCPKG_BUILD_TYPE)
        ...
        vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/tools/${PORT}/debug/fltk-config" "${CURRENT_INSTALLED_DIR}" "`dirname $0`/../../..")

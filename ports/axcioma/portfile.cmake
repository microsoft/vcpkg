...
function(install_libraries SOURCE_PATH LIBRARIES)
  ...
  foreach(LIBRARY ${LIBRARIES})
    ...
    if(VCPKG_LIBRARY_LINKAGE STREQUAL dynamic)
      ...
      if(EXISTS ${LIB_PATH}/${VCPKG_TARGET_SHARED_LIBRARY_PREFIX}${LIBRARY}${VCPKG_TARGET_SHARED_LIBRARY_SUFFIX})
        if(VCPKG_TARGET_IS_WINDOWS)
          file(COPY ${LIB_PATH}/${VCPKG_TARGET_SHARED_LIBRARY_PREFIX}${LIBRARY}${VCPKG_TARGET_SHARED_LIBRARY_SUFFIX} DESTINATION ${CURRENT_PACKAGES_DIR}/bin)
        else()
          vcpkg_execute_required_process(COMMAND cp "${LIB_PATH}/${VCPKG_TARGET_SHARED_LIBRARY_PREFIX}${LIBRARY}${VCPKG_TARGET_SHARED_LIBRARY_SUFFIX}" "${CURRENT_PACKAGES_DIR}/lib/" WORKING_DIRECTORY ${SOURCE_PATH} LOGNAME copy-libs-${VCPKG_BUILD_TYPE}-${TARGET_TRIPLET})
        endif()
      endif()
      if(EXISTS ${LIB_PATH}/${VCPKG_TARGET_SHARED_LIBRARY_PREFIX}${LIBRARY}d${VCPKG_TARGET_SHARED_LIBRARY_SUFFIX})
        if(VCPKG_TARGET_IS_WINDOWS)
          file(COPY ${LIB_PATH}/${VCPKG_TARGET_SHARED_LIBRARY_PREFIX}${LIBRARY}d${VCPKG_TARGET_SHARED_LIBRARY_SUFFIX} DESTINATION ${CURRENT_PACKAGES_DIR}/debug/bin)
        else()
          vcpkg_execute_required_process(COMMAND cp "${LIB_PATH}/${VCPKG_TARGET_SHARED_LIBRARY_PREFIX}${LIBRARY}d${VCPKG_TARGET_SHARED_LIBRARY_SUFFIX}" "${CURRENT_PACKAGES_DIR}/debug/lib/" WORKING_DIRECTORY ${SOURCE_PATH} LOGNAME copy-libs-${VCPKG_BUILD_TYPE}-${TARGET_TRIPLET})
        endif()
      endif()
    endif()
    # Install the lib files
    if(EXISTS ${LIB_PATH}/${VCPKG_TARGET_SHARED_LIBRARY_PREFIX}${LIBRARY}${DLL_DECORATOR}${VCPKG_TARGET_IMPORT_LIBRARY_SUFFIX})
      if(VCPKG_TARGET_IS_WINDOWS)
        file(COPY ${LIB_PATH}/${VCPKG_TARGET_SHARED_LIBRARY_PREFIX}${LIBRARY}${DLL_DECORATOR}${VCPKG_TARGET_IMPORT_LIBRARY_SUFFIX} DESTINATION ${CURRENT_PACKAGES_DIR}/lib)
      else()        
        vcpkg_execute_required_process(COMMAND cp "${LIB_PATH}${VCPKG_TARGET_SHARED_LIBRARY_PREFIX}${LIBRARY}${DLL_DECORATOR}${VCPKG_TARGET_IMPORT_LIBRARY_SUFFIX}" "${CURRENT_PACKAGES_DIR}/lib/" WORKING_DIRECTORY ${SOURCE_PATH} LOGNAME copy-libs-${VCPKG_BUILD_TYPE}-${TARGET_TRIPLET})
      endif()
    endif()
    if(EXISTS ${LIB_PATH}/${VCPKG_TARGET_SHARED_LIBRARY_PREFIX}${LIBRARY}${DLL_DECORATOR}d${VCPKG_TARGET_IMPORT_LIBRARY_SUFFIX})
      if(VCPKG_TARGET_IS_WINDOWS)
        file(COPY ${LIB_PATH}/${VCPKG_TARGET_SHARED_LIBRARY_PREFIX}${LIBRARY}${DLL_DECORATOR}d${VCPKG_TARGET_IMPORT_LIBRARY_SUFFIX} DESTINATION ${CURRENT_PACKAGES_DIR}/debug/lib)
      else()        
        vcpkg_execute_required_process(COMMAND cp "${LIB_PATH}${VCPKG_TARGET_SHARED_LIBRARY_PREFIX}${LIBRARY}${DLL_DECORATOR}d${VCPKG_TARGET_IMPORT_LIBRARY_SUFFIX}" "${CURRENT_PACKAGES_DIR}/debug/lib/" WORKING_DIRECTORY ${SOURCE_PATH} LOGNAME copy-libs-${VCPKG_BUILD_TYPE}-${TARGET_TRIPLET})
      endif()
    endif()         
  endforeach()
endfunction()
...
if(BUILD_TAO) 
  if(VCPKG_LIBRARY_LINKAGE STREQUAL dynamic)
    if(VCPKG_TARGET_IS_WINDOWS)
      file(COPY ${ACE_ROOT}/lib/${VCPKG_TARGET_SHARED_LIBRARY_PREFIX}ACEd${VCPKG_TARGET_SHARED_LIBRARY_SUFFIX} DESTINATION ${CURRENT_PACKAGES_DIR}/tools/${PORT}/bin)
      file(COPY ${ACE_ROOT}/lib/${VCPKG_TARGET_SHARED_LIBRARY_PREFIX}TAO_IDL_FEd${VCPKG_TARGET_SHARED_LIBRARY_SUFFIX} DESTINATION ${CURRENT_PACKAGES_DIR}/tools/${PORT}/bin)
      file(COPY ${ACE_ROOT}/lib/${VCPKG_TARGET_SHARED_LIBRARY_PREFIX}TAO_IDL_BEd${VCPKG_TARGET_SHARED_LIBRARY_SUFFIX} DESTINATION ${CURRENT_PACKAGES_DIR}/tools/${PORT}/bin)
    else()        
      ...
      vcpkg_execute_required_process(COMMAND cp "${ACE_ROOT}/lib/${VCPKG_TARGET_SHARED_LIBRARY_PREFIX}ACEd${VCPKG_TARGET_SHARED_LIBRARY_SUFFIX}" "${CURRENT_PACKAGES_DIR}/tools/${PORT}/bin" WORKING_DIRECTORY ${SOURCE_PATH} LOGNAME copy-libs-${VCPKG_BUILD_TYPE}-${TARGET_TRIPLET})
      vcpkg_execute_required_process(COMMAND cp "${ACE_ROOT}/lib/${VCPKG_TARGET_SHARED_LIBRARY_PREFIX}TAO_IDL_FEd${VCPKG_TARGET_SHARED_LIBRARY_SUFFIX}" "${CURRENT_PACKAGES_DIR}/tools/${PORT}/bin" WORKING_DIRECTORY ${SOURCE_PATH} LOGNAME copy-libs-${VCPKG_BUILD_TYPE}-${TARGET_TRIPLET})
      vcpkg_execute_required_process(COMMAND cp "${ACE_ROOT}/lib/${VCPKG_TARGET_SHARED_LIBRARY_PREFIX}TAO_IDL_BEd${VCPKG_TARGET_SHARED_LIBRARY_SUFFIX}" "${CURRENT_PACKAGES_DIR}/tools/${PORT}/bin" WORKING_DIRECTORY ${SOURCE_PATH} LOGNAME copy-libs-${VCPKG_BUILD_TYPE}-${TARGET_TRIPLET})
    endif()
  endif()
  if(VCPKG_TARGET_IS_WINDOWS)

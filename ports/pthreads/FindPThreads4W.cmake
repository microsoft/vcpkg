...
if(NOT PThreads4W_INCLUDE_DIR)
  find_path(PThreads4W_INCLUDE_DIR NAMES pthread.h PATHS "${VCPKG_INSTALLED_DIR}/include" NO_DEFAULT_PATH)
endif()
...
if(NOT PThreads4W_LIBRARY)
  find_library(PThreads4W_LIBRARY_RELEASE NAMES pthreadVC${PThreads4W_MAJOR_VERSION} PATHS "${VCPKG_INSTALLED_DIR}/lib" NO_DEFAULT_PATH)
  find_library(PThreads4W_LIBRARY_DEBUG NAMES pthreadVC${PThreads4W_MAJOR_VERSION}d PATHS "${VCPKG_INSTALLED_DIR}/debug/lib" NO_DEFAULT_PATH)
  select_library_configurations(PThreads4W)
endif()
if(NOT PThreads4W_CXXEXC_LIBRARY)
  find_library(PThreads4W_CXXEXC_LIBRARY_RELEASE NAMES pthreadVCE${PThreads4W_MAJOR_VERSION} PATHS "${VCPKG_INSTALLED_DIR}/lib" NO_DEFAULT_PATH)
  find_library(PThreads4W_CXXEXC_LIBRARY_DEBUG NAMES pthreadVCE${PThreads4W_MAJOR_VERSION}d PATHS "${VCPKG_INSTALLED_DIR}/debug/lib" NO_DEFAULT_PATH)
  select_library_configurations(PThreads4W_CXXEXC)
endif()
if(NOT PThreads4W_STRUCTEXC_LIBRARY)
  find_library(PThreads4W_STRUCTEXC_LIBRARY_RELEASE NAMES pthreadVSE${PThreads4W_MAJOR_VERSION} PATHS "${VCPKG_INSTALLED_DIR}/lib" NO_DEFAULT_PATH)
  find_library(PThreads4W_STRUCTEXC_LIBRARY_DEBUG NAMES pthreadVSE${PThreads4W_MAJOR_VERSION}d PATHS "${VCPKG_INSTALLED_DIR}/debug/lib" NO_DEFAULT_PATH)

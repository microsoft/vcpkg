...
function(vcpkg_generate_meson_cmd_args)
    ...
    if(arg_CONFIG STREQUAL "RELEASE")
      ...
      vcpkg_list(APPEND arg_OPTIONS "--pkg-config-path;['$ENV{PKG_CONFIG_PATH}','${CURRENT_INSTALLED_DIR}/lib/pkgconfig','${CURRENT_INSTALLED_DIR}/share/pkgconfig']")
      if(VCPKG_TARGET_IS_WINDOWS)
    ...
    elseif(arg_CONFIG STREQUAL "DEBUG")
      ...
      vcpkg_list(APPEND arg_OPTIONS "--pkg-config-path;['$ENV{PKG_CONFIG_PATH}','${CURRENT_INSTALLED_DIR}/debug/lib/pkgconfig','${CURRENT_INSTALLED_DIR}/share/pkgconfig']")
      if(VCPKG_TARGET_IS_WINDOWS)

...
set(SDL_IMAGE_DEPENDENCIES "PNG")

if("libjpeg-turbo" IN_LIST FEATURES)
    list(APPEND SDL_IMAGE_DEPENDENCIES "JPEG")
endif()

if("tiff" IN_LIST FEATURES)
    list(APPEND SDL_IMAGE_DEPENDENCIES "TIFF")
endif()

if("libwebp" IN_LIST FEATURES)
    list(APPEND SDL_IMAGE_DEPENDENCIES "WEBP")
endif()

vcpkg_configure_cmake(
    SOURCE_PATH ${SOURCE_PATH}
    PREFER_NINJA
    OPTIONS -DSDL_IMAGE_DEPENDENCIES="${SDL_IMAGE_DEPENDENCIES}"

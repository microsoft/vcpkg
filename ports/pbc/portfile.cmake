...
if(VCPKG_CMAKE_SYSTEM_NAME)
    ...
    find_path(GMP_INCLUDE_DIR "gmp.h" HINTS ${CURRENT_INSTALLED_DIR} PATH_SUFFIXES include)

    find_library(GMP_LIBRARIES_DBG NAMES "libgmp" HINTS ${CURRENT_INSTALLED_DIR} PATH_SUFFIXES debug/lib)
    get_filename_component(GMP_LIBRARIES_DBG ${GMP_LIBRARIES_DBG} DIRECTORY)

    find_library(GMP_LIBRARIES_REL NAMES "libgmp" HINTS ${CURRENT_INSTALLED_DIR} PATH_SUFFIXES lib)
    get_filename_component(GMP_LIBRARIES_REL ${GMP_LIBRARIES_REL} DIRECTORY)
    ...
    set(ENV{CFLAGS} "${VCPKG_C_FLAGS} ${VCPKG_C_FLAGS_DEBUG} -O0 -g -I${SOURCE_PATH}/include -I${GMP_INCLUDE_DIR}")
    set(ENV{LDFLAGS} "${VCPKG_LINKER_FLAGS} -L${GMP_LIBRARIES_DBG}")
    vcpkg_execute_required_process(
    ...
    set(ENV{CFLAGS} "${VCPKG_C_FLAGS} ${VCPKG_C_FLAGS_RELEASE} -O3 -I${SOURCE_PATH}/include -I${GMP_INCLUDE_DIR}")
    set(ENV{LDFLAGS} "${VCPKG_LINKER_FLAGS} -L${GMP_LIBRARIES_REL}")
    vcpkg_execute_required_process(

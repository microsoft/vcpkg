...
if(VCPKG_TARGET_IS_WINDOWS AND NOT VCPKG_TARGET_IS_MINGW)
    ...
    if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "release")
        ...
        file(RENAME "${CURRENT_PACKAGES_DIR}/lib/${LIB_NAME}" "${CURRENT_PACKAGES_DIR}/lib/libmpdec.lib")
        if(INSTALL_DLL)
    ...
    if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "debug")
        ...
        file(RENAME "${CURRENT_PACKAGES_DIR}/debug/lib/${LIB_NAME}" "${CURRENT_PACKAGES_DIR}/debug/lib/libmpdec.lib")
        if(INSTALL_DLL)

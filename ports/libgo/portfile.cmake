...
vcpkg_from_github(
    ...
    HEAD_REF master
    PATCHES
        remove-compiler-flags.patch
        out-of-source-configure.patch
)

file(REMOVE_RECURSE ${SOURCE_PATH}/third_party/gtest ${SOURCE_PATH}/third_party/xhook ${SOURCE_PATH}/third_party/boost.context)
file(GLOB EXTRACTED_STAMPS ${SOURCE_PATH}/third_party/*.extracted)
if(EXTRACTED_STAMPS)
    file(REMOVE ${EXTRACTED_STAMPS})
endif()

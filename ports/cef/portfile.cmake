...
if(NOT EXISTS "${SOURCE_PATH}/include")
    message(FATAL_ERROR "cef: include directory not found in the extracted archive.")
endif()
...
elseif(EXISTS "${SOURCE_PATH}/LICENSE")
    ...
    message(FATAL_ERROR "cef: could not find LICENSE file in the extracted archive.")
endif()

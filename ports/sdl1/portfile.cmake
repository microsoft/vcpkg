...
if (VCPKG_TARGET_IS_WINDOWS)
    ...
    if(VCPKG_LIBRARY_LINKAGE STREQUAL "static")
        if (VCPKG_CRT_LINKAGE STREQUAL "dynamic")
            configure_file(${CMAKE_CURRENT_LIST_DIR}/SDL_static_dyncrt.vcxproj  ${SOURCE_PATH}/VisualC/SDL/SDL.vcxproj COPYONLY)
            configure_file(${CMAKE_CURRENT_LIST_DIR}/SDLmain_static_dyncrt.vcxproj ${SOURCE_PATH}/VisualC/SDLmain/SDLmain.vcxproj COPYONLY)
        else()

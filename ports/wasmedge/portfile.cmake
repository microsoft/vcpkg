...
if(VCPKG_TARGET_IS_WINDOWS)
    list(APPEND WASMEDGE_CMAKE_OPTIONS "-DCMAKE_CXX_COMPILER=${CLANG}/bin/clang-cl.exe")
    list(APPEND WASMEDGE_CMAKE_OPTIONS "-DCMAKE_C_COMPILER=${CLANG}/bin/clang-cl.exe")
endif()

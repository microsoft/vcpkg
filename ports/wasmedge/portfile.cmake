...
if(VCPKG_TARGET_IS_WINDOWS)
    list(APPEND WASMEDGE_CMAKE_OPTIONS "-DCMAKE_CXX_COMPILER=${CURRENT_HOST_INSTALLED_DIR}/tools/llvm/clang-cl.exe")
    list(APPEND WASMEDGE_CMAKE_OPTIONS "-DCMAKE_C_COMPILER=${CURRENT_HOST_INSTALLED_DIR}/tools/llvm/clang-cl.exe")
endif()

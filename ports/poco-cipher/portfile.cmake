...
if(EXISTS "${CURRENT_PACKAGES_DIR}/include/Poco/SQL/SQLiteCipher")
    file(COPY ${SOURCE_PATH}/Data/SQLiteCipher/include DESTINATION ${CURRENT_PACKAGES_DIR})
endif()

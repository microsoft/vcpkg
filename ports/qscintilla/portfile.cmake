...
if(CMAKE_HOST_WIN32)
    configure_file(${RELEASE_DIR}/qscintilla2_qt5.lib ${CURRENT_PACKAGES_DIR}/lib/qscintilla2.lib COPYONLY)
    configure_file(${DEBUG_DIR}/qscintilla2_qt5.lib ${CURRENT_PACKAGES_DIR}/debug/lib/qscintilla2.lib COPYONLY)

    if(VCPKG_LIBRARY_LINKAGE STREQUAL dynamic)
        file(COPY ${RELEASE_DIR}/qscintilla2_qt5.dll DESTINATION ${CURRENT_PACKAGES_DIR}/bin)
        file(COPY ${DEBUG_DIR}/qscintilla2_qt5.dll DESTINATION ${CURRENT_PACKAGES_DIR}/debug/bin)
    endif()

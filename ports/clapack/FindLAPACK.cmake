...
if(NOT LAPACK_LIBRARY)
  ...
  get_property(_loc TARGET BLAS::BLAS PROPERTY IMPORTED_IMPLIB_RELEASE)
  if(NOT _loc)
    get_property(_loc TARGET BLAS::BLAS PROPERTY LOCATION_RELEASE)
  endif()
  set(LAPACK_BLAS_LIBRARY_RELEASE ${_loc})
  get_property(_loc TARGET BLAS::BLAS PROPERTY IMPORTED_IMPLIB_DEBUG)
  if(NOT _loc)
    get_property(_loc TARGET BLAS::BLAS PROPERTY LOCATION_DEBUG)
  endif()
...
if(CLAPACK_FOUND AND NOT TARGET lapack)
    ...
    target_link_libraries(lapack INTERFACE LAPACK::LAPACK)
endif()

...
if(WIN32)
  find_path(LAPACK_LIBRARY_RELEASE_FOLDER NAMES lapack.dll PATHS ${LAPACK_DLL_DIR})
  set(LAPACK_LIBRARY_RELEASE_DLL "${LAPACK_LIBRARY_RELEASE_FOLDER}/lapack.dll")
  find_path(LAPACK_LIBRARY_DEBUG_FOLDER NAMES lapackd.dll PATHS ${LAPACK_DLL_DIR})
  set(LAPACK_LIBRARY_DEBUG_DLL "${LAPACK_LIBRARY_DEBUG_FOLDER}/lapackd.dll")
  find_path(F2C_LIBRARY_RELEASE_FOLDER NAMES f2c.dll libf2c.dll PATHS ${LAPACK_DLL_DIR})
  set(F2C_LIBRARY_RELEASE_DLL "${F2C_LIBRARY_RELEASE_FOLDER}/f2c.dll")
  find_path(F2C_LIBRARY_DEBUG_FOLDER NAMES f2cd.dll libf2cd.dll PATHS ${LAPACK_DLL_DIR})
  set(F2C_LIBRARY_DEBUG_DLL "${F2C_LIBRARY_DEBUG_FOLDER}/f2cd.dll")
endif()

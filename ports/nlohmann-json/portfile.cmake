...
vcpkg_download_distfile(HEADER
    ...
    FILENAME "nlohmann-json-v${SOURCE_VERSION}/single_include/nlohmann/json.hpp"
...
vcpkg_download_distfile(nlohmann_json.natvis
    ...
    FILENAME "nlohmann-json-v${SOURCE_VERSION}/nlohmann-json.natvis"
...
file(
    COPY 
        ...
        ${DOWNLOADS}/nlohmann-json-v${SOURCE_VERSION}/nlohmann-json.natvis
    DESTINATION
        ${SOURCE_PATH}
)
...
file(
    COPY 
        ${DOWNLOADS}/nlohmann-json-v${SOURCE_VERSION}/single_include/nlohmann/json.hpp
    DESTINATION
        ${SOURCE_PATH}/single_include/nlohmann
)
...
vcpkg_replace_string(${SOURCE_PATH}/CMakeLists.txt "nlohmann_json" "nlohmann-json")
...
file(REMOVE
    ${CURRENT_PACKAGES_DIR}/nlohmann-json.natvis
)

...
vcpkg_from_github(
    ...
    PATCHES
        ...
        003-fix-macos-catalina.patch # https://github.com/Homebrew/homebrew-core/pull/46928
)
...
if (VCPKG_TARGET_IS_WINDOWS)
    ...
    vcpkg_configure_make(
        ...
        MAKE_INSTALL_OPTIONS_RELEASE
            ...
            "INSTALL_BIN=${CURRENT_PACKAGES_DIR}/tools/${PORT}"
            "INSTALL_INC=${CURRENT_PACKAGES_DIR}/include/${PORT}"
    ...
    file(REMOVE_RECURSE ${CURRENT_PACKAGES_DIR}/lib/lua)

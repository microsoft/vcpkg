...
"
  ...
  if(EXISTS "${CURRENT_INSTALLED_DIR}/lib/python${PYTHON3_VERSION_MAJOR}${PYTHON3_VERSION_MINOR}${PYTHON3_ABI_SUFFIX}.lib")
    ...
    file(COPY "${CURRENT_INSTALLED_DIR}/lib/python${PYTHON3_VERSION_MAJOR}${PYTHON3_VERSION_MINOR}${PYTHON3_ABI_SUFFIX}.lib" DESTINATION "${python_base}/${suffix}")

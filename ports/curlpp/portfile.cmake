...
if(VCPKG_TARGET_IS_WINDOWS AND NOT (VCPKG_LIBRARY_LINKAGE STREQUAL static))
    ...
    vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/bin/curlpp-config" "${CURRENT_HOST_INSTALLED_DIR}" "$(prefix)/../${_HOST_TRIPLET}" IGNORE_UNCHANGED)
    if(NOT VCPKG_BUILD_TYPE)
        ...
        vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/debug/bin/curlpp-config" "${CURRENT_HOST_INSTALLED_DIR}" "$(prefix)/../${_HOST_TRIPLET}" IGNORE_UNCHANGED)
    endif()
endif()

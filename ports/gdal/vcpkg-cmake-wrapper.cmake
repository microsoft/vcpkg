...
if(GDAL_FOUND)
    ...
    if(TARGET SPATIALITE::SPATIALITE)
        find_package(PkgConfig REQUIRED)
        pkg_check_modules(SPATIALITE IMPORTED_TARGET spatialite)
        set_target_properties(SPATIALITE::SPATIALITE PROPERTIES INTERFACE_LINK_LIBRARIES PkgConfig::SPATIALITE)
    endif()
endif()

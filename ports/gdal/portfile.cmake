...
if (VCPKG_TARGET_IS_WINDOWS OR VCPKG_TARGET_IS_UWP)
  ...
  find_library(XML2_LIBRARY_REL NAMES libxml2 libxml2s PATHS ${CURRENT_INSTALLED_DIR}/lib)
  find_library(XML2_LIBRARY_DBG NAMES libxml2d libxml2sd PATHS ${CURRENT_INSTALLED_DIR}/debug/lib)
  file(TO_NATIVE_PATH "${CURRENT_INSTALLED_DIR}/include/libxml2" XML2_INCLUDE_DIR)
  file(TO_NATIVE_PATH ${XML2_LIBRARY_REL} XML2_LIBRARY_REL)
  file(TO_NATIVE_PATH ${XML2_LIBRARY_DBG} XML2_LIBRARY_DBG)

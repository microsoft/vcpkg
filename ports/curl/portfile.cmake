...
vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/bin/curl-config" "${CURRENT_HOST_INSTALLED_DIR}" "\${prefix}/../${_HOST_TRIPLET}" IGNORE_UNCHANGED)
...
if(EXISTS "${CURRENT_PACKAGES_DIR}/debug/bin/curl-config")
    ...
    vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/debug/bin/curl-config" "${CURRENT_HOST_INSTALLED_DIR}" "\${prefix}/../${_HOST_TRIPLET}" IGNORE_UNCHANGED)

...
if( VCPKG_TARGET_IS_WINDOWS)
    if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "debug")
        vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/libcurl.pc" "-lcurl" "-llibcurl-d")
        vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/libcurl.pc" "${CURRENT_INSTALLED_DIR}/lib/zlib.lib" "-lzlibd")
    endif()

    if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "release")
        vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/lib/pkgconfig/libcurl.pc" "-lcurl" "-llibcurl")
        vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/lib/pkgconfig/libcurl.pc" "${CURRENT_INSTALLED_DIR}/lib/zlib.lib" "-lzlib")
    endif()

    vcpkg_fixup_pkgconfig(SYSTEM_LIBRARIES wldap32 crypt32)
else()
    if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "debug")
        vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/libcurl.pc" "-lcurl" "-lcurl-d")
        vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/libcurl.pc" "${CURRENT_INSTALLED_DIR}/debug/lib/libssl.a" "-lssl")
        vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/libcurl.pc" "${CURRENT_INSTALLED_DIR}/debug/lib/libcrypto.a" "-lcrypto")
        vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/libcurl.pc" "${CURRENT_INSTALLED_DIR}/debug/lib/libz.a" "-lz")
    endif()

    if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "release")
        vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/lib/pkgconfig/libcurl.pc" "${CURRENT_INSTALLED_DIR}/lib/libssl.a" "-lssl")
        vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/lib/pkgconfig/libcurl.pc" "${CURRENT_INSTALLED_DIR}/lib/libcrypto.a" "-lcrypto")
        vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/lib/pkgconfig/libcurl.pc" "${CURRENT_INSTALLED_DIR}/lib/libz.a" "-lz")
    endif()

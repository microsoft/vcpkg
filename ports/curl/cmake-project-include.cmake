...
if(NOT CURL_DISABLE_LDAP AND NOT USE_WIN32_LDAP)
    find_package(PkgConfig REQUIRED)
    pkg_check_modules(LDAP REQUIRED IMPORTED_TARGET ldap)
    set(HAVE_LIBLDAP "${LDAP_FOUND}")
    set(CMAKE_LDAP_INCLUDE_DIR "${LDAP_INCLUDE_DIRS}")
    set(CMAKE_LDAP_LIB "${LDAP_LINK_LIBRARIES}" CACHE STRING "")
    pkg_check_modules(LBER REQUIRED IMPORTED_TARGET lber)
    set(HAVE_LIBLBER "${LBER_FOUND}")

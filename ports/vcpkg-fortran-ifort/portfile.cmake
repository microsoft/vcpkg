...
set(LIBDIR "\${prefix}/share/ifort")
configure_file("${CMAKE_CURRENT_LIST_DIR}/vcpkg-fortran-ifort.pc.in" "${CURRENT_PACKAGES_DIR}/lib/pkgconfig/vcpkg-fortran-ifort.pc" @ONLY)
if(NOT VCPKG_BUILD_TYPE)
    set(LIBDIR "\${prefix}/../share/ifort")
    configure_file("${CMAKE_CURRENT_LIST_DIR}/vcpkg-fortran-ifort.pc.in" "${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/vcpkg-fortran-ifort.pc" @ONLY)
endif()

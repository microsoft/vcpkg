...
उपयोग कैसे शुरू करें के लिए हमारे [शुरू हो जाओd](#getting-started) खंड की जांच करें।
...
पहले, आपको जो भी उपयोग कर रहे हैं, [Windows](#quick-start-windows), or [macOS और Linux](#quick-start-unix),
...
आप अपने शैल में [tab पूर्णता](#tab-completionauto-completion) जोड़ना चाह सकते हैं।
...
तो [यहां](#vcpkg-with-visual-studio-cmake-projects) जारी रखें।.
...
और अधिक जानकारी के लिए [CMake अनुभाग](#using-vcpkg-with-cmake) देखें,
...
vcpkg का CMake के साथ सबसे अच्छा तरीके से उपयोग कैसे करें, और VSCode के लिए CMake टूल्स के बारे में अधिक जानकारी के लिए, [CMake अनुभाग](#using-vcpkg-with-cmake) देखें।
...
फिर आप vcpkg को bootstrap कर सकेंगे, साथ ही [त्वरित प्रारंभ गाइड](#quick-start-unix) के साथ।

...
namespace vcpkg
{
    ...
    struct VcpkgCmdArguments
    {
        ...
        constexpr static StringLiteral BUILTIN_PORT_VERSIONS_ROOT_DIR_ARG = "x-builtin-port-versions-root";
        std::unique_ptr<std::string> builtin_port_versions_root_dir;

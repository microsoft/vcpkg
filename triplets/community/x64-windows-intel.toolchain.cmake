...
find_program(ICL_EXECUTABLE NAMES "icl" "icl.exe" PATHS "${COMPILER_VERSIONS}" PATH_SUFFIXES "windows/bin/intel64")
find_program(IFORT_EXECUTBALE NAMES "ifort" "ifort.exe" PATHS "${COMPILER_VERSIONS}" PATH_SUFFIXES "windows/bin/intel64")

if(NOT ICL_EXECUTABLE)
  message(SEND_ERROR "Intel Compiler icx was not found!")
endif()

get_filename_component(INTEL_BIN_DIR "${ICL_EXECUTABLE}" DIRECTORY)
list(INSERT CMAKE_PROGRAM_PATH 0 "${INTEL_BIN_DIR}")

set(CMAKE_C_COMPILER "${ICL_EXECUTABLE}" CACHE STRING "" FORCE)
set(CMAKE_CXX_COMPILER "${ICL_EXECUTABLE}" CACHE STRING "" FORCE)
#set(CMAKE_ASM_COMPILER "${ICL_EXECUTABLE}" CACHE STRING "" FORCE)
set(CMAKE_Fortran_COMPILER "${IFORT_EXECUTBALE}" CACHE STRING "" FORCE) # unfortunally currently only works if cmake rules are bend a bit. 

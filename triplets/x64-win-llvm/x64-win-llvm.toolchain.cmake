...
set(CMAKE_C_FLAGS "${CMAKE_CL_NOLOGO} -fuse-ld=lld ${windows_defs} ${arch_flags} ${VCPKG_C_FLAGS} ${CLANG_FLAGS} ${CHARSET_FLAG} ${std_c_flags} ${ignore_werror}" CACHE STRING "")
...
set(CMAKE_CXX_FLAGS "${CMAKE_CL_NOLOGO} -fuse-ld=lld /EHsc /GR ${windows_defs} ${arch_flags} ${VCPKG_CXX_FLAGS} ${CLANG_FLAGS} ${CHARSET_FLAG} ${std_cxx_flags} ${ignore_werror}" CACHE STRING "")
...
foreach(linker IN ITEMS "SHARED_LINKER;MODULE_LINKER;EXE_LINKER")
  set(CMAKE_${linker}_FLAGS_INIT "-fuse-ld=lld /VERBOSE /INCREMENTAL:NO /Brepro ${VCPKG_LINKER_FLAGS}" CACHE STRING "")

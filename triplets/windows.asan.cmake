...
if(VCPKG_USE_SANITIZERS)
    ...
    if(NOT VCPKG_USE_COMPILER_FOR_LINKAGE)
      if(VCPKG_CRT_LINKAGE STREQUAL "dynamic")
        ...
        set(sanitizer_libs_exe_rel "clang_rt.asan_dynamic-${asan_arch}.lib /wholearchive:clang_rt.asan_dynamic_runtime_thunk-${asan_arch}.lib")
        set(sanitizer_libs_dll_rel "${sanitizer_libs_exe_rel}")
        set(sanitizer_libs_exe_dbg "clang_rt.asan_dynamic-${asan_arch}.lib /wholearchive:clang_rt.asan_dynamic_runtime_thunk-${asan_arch}.lib")

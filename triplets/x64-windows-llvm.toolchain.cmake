...
set(CMAKE_C_FLAGS "${CMAKE_CL_NOLOGO} ${windows_defs} /arch:AVX ${VCPKG_C_FLAGS} ${CLANG_FLAGS} ${CHARSET_FLAG} ${std_c_flags}" CACHE STRING "")
...
set(CMAKE_CXX_FLAGS "${CMAKE_CL_NOLOGO} ${windows_defs} /arch:AVX /EHsc /GR ${VCPKG_CXX_FLAGS} ${CLANG_FLAGS} ${CHARSET_FLAG} ${std_cxx_flags}" CACHE STRING "")

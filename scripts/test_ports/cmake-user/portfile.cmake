...
function(check_usage port package)
    if(NOT ${port}_USAGE_CHECK_DONE)
        set(ignore_missing_usage boost)
        if(port IN_LIST ignore_missing_usage)
            # ignore
        elseif(NOT EXISTS "${CURRENT_INSTALLED_DIR}/share/${port}/usage")
            message(SEND_ERROR "${port} is compatible with the CMake Find Module for ${package}, but doesn't install a usage file.")
        endif()
        set(${port}_USAGE_CHECK_DONE 1 CACHE INTERNAL "")
    endif()
endfunction()

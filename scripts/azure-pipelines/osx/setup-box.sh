...
brew install autoconf-archive autoconf automake azcopy azure-cli bison cmake gettext gfortran gnu-sed gperf gtk-doc libtool meson nasm ninja pkg-config powershell python-setuptools texinfo yasm
mkdir ~/Data

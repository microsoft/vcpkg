...
# Set up VCPKG_ROOT, VCPKG_COMMAND and CMAKE_TOOLCHAIN_FILE if not already defined
if (NOT DEFINED VCPKG_ROOT)
  get_filename_component(VCPKG_ROOT ${CMAKE_CURRENT_LIST_DIR}/.. ABSOLUTE CACHE PATH "VCPKG Root directory" FORCE)
endif()
message(STATUS "VCPKG_ROOT = ${VCPKG_ROOT}")
if (NOT DEFINED VCPKG_COMMAND)
  set(VCPKG_COMMAND "${VCPKG_ROOT}/vcpkg" ABSOLUTE CACHE FILEPATH "Path to VCPKG executable" FORCE)
endif()
message(STATUS "VCPKG_COMMAND = ${VCPKG_COMMAND}")
if (NOT DEFINED CMAKE_TOOLCHAIN_FILE)
  set(CMAKE_TOOLCHAIN_FILE "${VCPKG_ROOT}/scripts/buildsystems/vcpkg.cmake" ABSOLUTE CACHE FILEPATH "CMake toolchain file" FORCE)
endif()

...
if(CMD MATCHES "^BUILD$")
    ...
    if(EXISTS "${CURRENT_PACKAGES_DIR}/lib/libmath.a")
        message(FATAL_ERROR "[VCPKG-DEBUG]: Found libmath.a in ${PORT}")
    endif()
    if(NOT VCPKG_FIXUP_PKGCONFIG_CALLED)
        file(GLOB_RECURSE PC_FILES *.pc)
        if(EXISTS "${CURRENT_PACKAGES_DIR}/lib/pkgconfig/" OR PC_FILES)
            message(WARNING "[VCPKG-DEBUG]: ${PORT} has pkgconfig files and has not called vcpkg_fixup_pkgconfig")
        endif()
    endif()

    if(NOT VCPKG_FIXUP_CMAKE_CALLED)
        file(GLOB_RECURSE CMAKE_FILES *.cmake)
        if(CMAKE_FILES)
            message(WARNING "[VCPKG-DEBUG]: ${PORT} has cmake files and has not called vcpkg_fixup_cmake")
        endif()
    endif()

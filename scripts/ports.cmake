...
elseif(CMD MATCHES "^CREATE$")
    ...
    elseif (DOWNLOAD_WITH_GITLAB)
        configure_file(${SCRIPTS}/templates/vcpkg_gitlab_process.cmake.cmake.in ports/${PORT}/vcpkg_gitlab_process.cmake @ONLY)
    ...
    elseif (DOWNLOAD_WITH_GIT)
        configure_file(${SCRIPTS}/templates/vcpkg_git_process.cmake.cmake.in ports/${PORT}/vcpkg_git_process.cmake @ONLY)
        file(READ ports/${PORT}/vcpkg_git_process.cmake DOWNLOAD_PROCESS)
        file(REMOVE ports/${PORT}/vcpkg_git_process.cmake)
    else()
        #DOWNLOAD_WITH_URL
        configure_file(${SCRIPTS}/templates/vcpkg_url_process.cmake.cmake.in ports/${PORT}/vcpkg_url_process.cmake @ONLY)
    ...
    # Judge build process
    if (BUILD_WITH_MAKE)
        configure_file(${SCRIPTS}/templates/vcpkg_make_process.cmake.cmake.in ports/${PORT}/vcpkg_make_process.cmake @ONLY)
        file(READ ports/${PORT}/vcpkg_make_process.cmake BUILD_PROCESS)
        file(REMOVE ports/${PORT}/vcpkg_make_process.cmake)
    elseif (BUILD_WITH_NMAKE)
        configure_file(${SCRIPTS}/templates/vcpkg_nmake_process.cmake.cmake.in ports/${PORT}/vcpkg_nmake_process.cmake @ONLY)
        file(READ ports/${PORT}/vcpkg_nmake_process.cmake BUILD_PROCESS)
        file(REMOVE ports/${PORT}/vcpkg_nmake_process.cmake)
    elseif (BUILD_WITH_MSVC)
        configure_file(${SCRIPTS}/templates/vcpkg_msbuild_process.cmake.cmake.in ports/${PORT}/vcpkg_msbuild_process.cmake @ONLY)
        file(READ ports/${PORT}/vcpkg_msbuild_process.cmake BUILD_PROCESS)
        file(REMOVE ports/${PORT}/vcpkg_msbuild_process.cmake)
    elseif (BUILD_WITH_QMAKE)
        configure_file(${SCRIPTS}/templates/vcpkg_qmake_process.cmake.cmake.in ports/${PORT}/vcpkg_qmake_process.cmake @ONLY)
        file(READ ports/${PORT}/vcpkg_qmake_process.cmake BUILD_PROCESS)
        file(REMOVE ports/${PORT}/vcpkg_qmake_process.cmake)
    else()
        #BUILD_WITH_CMAKE
        configure_file(${SCRIPTS}/templates/vcpkg_cmake_process.cmake.cmake.in ports/${PORT}/vcpkg_cmake_process.cmake @ONLY)
        file(READ ports/${PORT}/vcpkg_cmake_process.cmake BUILD_PROCESS)
        file(REMOVE ports/${PORT}/vcpkg_cmake_process.cmake)
    endif()

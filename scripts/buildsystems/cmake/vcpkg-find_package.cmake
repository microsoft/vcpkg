...
macro(find_package name)
    ...
    elseif("${_vcpkg_lowercase_name}" STREQUAL "grpc" AND EXISTS "${_VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}/share/grpc")
        ...
        #        if("${${_pkg_var}}" MATCHES "${_VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}/lib") 
        #            # Release path instead of debug Path?
        ...
        #                if(NOT EXISTS "${_pkg_maybe_loc}") 
                           #TODO: We could try harder to find the correct library since we know where it should be. 
                            #The only thing we do not know is the exact name!
                            #Trying harder: (unfortunally this does not work in the _RELEASE case. )
        #                    if(${CMAKE_VERSION} VERSION_GREATER 3.13) # A backport for earlier cmake versions would be good
        ...
        #                        endif()
        #                    else()
        #                        message(WARNING "VCPKG-Warning-find_package: Could not locate debug libraries at: ${_pkg_maybe_loc}.")
        #                    endif()
        #                else()
        #                    message(STATUS "VCPKG-find_package: Sucessfully located debug libraries at: ${_pkg_maybe_loc}")
        #                    list(APPEND _tmp_var_list ${_pkg_maybe_loc})
        ...
        #            if(NOT "x${${_pkg_var}}" MATCHES "NOTFOUND")
        #                set(_pkg_library_debug_found 1)
        #            else() #NOT-Found
        ...
        #if("${_pkg_all_vars}" MATCHES "_RELEASE") # It seems like _RELEASE is always set to the DEBUG libraries for DEBUG builds?
        #    set(_pkg_tmp_vars "${_pkg_all_vars}")
        #    list(FILTER _pkg_tmp_vars INCLUDE REGEX "_RELEASE")
        #    #list(LENGTH _pkg_tmp_vars _pkg_tmp_length)
        #    foreach(_pkg_var ${_pkg_tmp_vars})
        #        if("${${_pkg_var}}" MATCHES "${_VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}/debug/lib") 
        #            # Debug path instead of release path?
        #            set(_tmp_var "${${_pkg_var}}")

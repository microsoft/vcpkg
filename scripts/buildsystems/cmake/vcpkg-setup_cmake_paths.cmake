...
#Debug Paths are required so that CMake generates correct info in autogenerated target files. If it can distingush both
#This setup will also be used by multi configuration generators
    list(APPEND CMAKE_PREFIX_PATH
        ${_VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET} 
        ${_VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}/debug
    )
...
#Setting up CMake search paths (always debug first!)
#list(APPEND CMAKE_PREFIX_PATH
#    ${_VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}/debug 
#    ${_VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}
#)

...
list(PREPEND CMAKE_PROGRAM_PATH ${_VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}/tools)
...
foreach(_VCPKG_TOOLS_DIR IN LISTS _VCPKG_TOOLS_DIRS)
    if(IS_DIRECTORY "${_VCPKG_TOOLS_DIR}")
        list(PREPEND CMAKE_PROGRAM_PATH "${_VCPKG_TOOLS_DIR}")
    endif()
endforeach()
...
macro(${VCPKG_OVERRIDE_FIND_PACKAGE_NAME} name)
    ...
    if(CMAKE_SYSTEM_NAME STREQUAL iOS)
        ...
        list(PREPEND CMAKE_FIND_ROOT_PATH ${VCPKG_CMAKE_FIND_ROOT_PATH})
    endif()

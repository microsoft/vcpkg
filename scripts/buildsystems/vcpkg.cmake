...
# For cmake_pkg_config, introduced in CMake 3.31
if(CMAKE_VERSION VERSION_GREATER_EQUAL "3.31")
    if (DEFINED VCPKG_PKG_CONFIG_PC_PATH)
        if(NOT DEFINED CMAKE_BUILD_TYPE OR CMAKE_BUILD_TYPE MATCHES "^[Dd][Ee][Bb][Uu][Gg]$")
            list(APPEND CMAKE_PKG_CONFIG_PC_PATH "${VCPKG_PKG_CONFIG_PC_PATH}/debug/lib/pkgconfig" "${VCPKG_PKG_CONFIG_PC_PATH}/debug/share/pkgconfig")
        else()
            list(APPEND CMAKE_PKG_CONFIG_PC_PATH "${VCPKG_PKG_CONFIG_PC_PATH}/lib/pkgconfig" "${VCPKG_PKG_CONFIG_PC_PATH}/share/pkgconfig")
        endif()
    endif()
    if(NOT DEFINED CMAKE_BUILD_TYPE OR CMAKE_BUILD_TYPE MATCHES "^[Dd][Ee][Bb][Uu][Gg]$")
        list(APPEND CMAKE_PKG_CONFIG_PC_PATH "${VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}/debug/lib/pkgconfig" "${VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}/debug/share/pkgconfig")
    else()
        list(APPEND CMAKE_PKG_CONFIG_PC_PATH "${VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}/lib/pkgconfig" "${VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}/share/pkgconfig")
    endif()
elseif (DEFINED VCPKG_PKG_CONFIG_PC_PATH OR DEFINED VCPKG_PKG_CONFIG_PC_PATH_DBG OR DEFINED VCPKG_PKG_CONFIG_PC_PATH_REL)
    message(WARNING "VCPKG_PKG_CONFIG_PC_PATH will not be enabled when CMake version less than 3.31")
endif()

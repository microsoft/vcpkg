...
function("${VCPKG_OVERRIDE_FIND_PACKAGE_NAME}")
    ...
    set(VCPKG_CMAKE_WRAPPER_PATH "${_VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}/share/${LOWERCASE_TARGET_NAME}/vcpkg-cmake-wrapper.cmake")

    z_vcpkg_start_parent_scope_export()
    if(EXISTS "${VCPKG_CMAKE_WRAPPER_PATH}")
        set(ARGS "${ESCAPED_ARGV}")
        include("${VCPKG_CMAKE_WRAPPER_PATH}")
    elseif("${TARGET_NAME}" STREQUAL "Boost" AND EXISTS "${_VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}/include/boost")
    ...
    elseif("${TARGET_NAME}" STREQUAL "ICU" AND EXISTS "${_VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}/include/unicode/utf.h")
    ...
    elseif("${TARGET_NAME}" STREQUAL "GSL" AND EXISTS "${_VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}/include/gsl")
        _find_package(${ESCAPED_ARGV})
    ...
    elseif("${TARGET_NAME}" STREQUAL "CURL" AND EXISTS "${_VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}/include/curl")
        _find_package(${ESCAPED_ARGV})
        if(CURL_FOUND)
    ...
    elseif("${LOWERCASE_TARGET_NAME}" STREQUAL "grpc" AND EXISTS "${_VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}/share/grpc")

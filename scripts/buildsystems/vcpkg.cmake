...
#]===]
function(z_vcpkg_get_command_underscores command_in underscores_out)
    set(_under "")
    if(COMMAND _${command_in})
        z_vcpkg_get_command_underscores(_under _${command_in})
        set(_under "_${_under}")
    endif()
...
macro("${Z_VCPKG_FIND_PACKAGE}" z_vcpkg_find_package_package_name)
    ...
    elseif(z_vcpkg_find_package_package_name STREQUAL "Boost" AND EXISTS "${_VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}/include/boost")
        ...
        if(Z_VCPKG_CHAIN_COMMANDS)
            cmake_language(CALL _${Z_VCPKG_FIND_PACKAGE} "${z_vcpkg_find_package_package_name}" ${z_vcpkg_find_package_ARGN})
        else()
    ...
    elseif(z_vcpkg_find_package_package_name STREQUAL "ICU" AND EXISTS "${_VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}/include/unicode/utf.h")
        ...
        if(NOT z_vcpkg_find_package_COMPONENTS_IDX EQUAL -1)
            if(Z_VCPKG_CHAIN_COMMANDS)
                cmake_language(CALL _${Z_VCPKG_FIND_PACKAGE} "${z_vcpkg_find_package_package_name}" ${z_vcpkg_find_package_ARGN} COMPONENTS data)
            else()
    ...
    elseif("${z_vcpkg_find_package_lowercase_package_name}" STREQUAL "grpc" AND EXISTS "${_VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}/share/grpc")
        if(Z_VCPKG_CHAIN_COMMANDS)
            cmake_language(CALL _${Z_VCPKG_FIND_PACKAGE} gRPC ${z_vcpkg_find_package_ARGN})
        else()

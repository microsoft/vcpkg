...
which evaluates to the needed library variant at cmake generation time.
...
function(z_vcpkg_find_configurations prefix)
    ...
    if(arg_LIBRARY_NAMES)
        find_library("${prefix}_LIBRARY_RELEASE"
            NAMES ${arg_LIBRARY_NAMES} NAMES_PER_DIR
            PATHS "${_VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}/lib" "${_VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}/debug/lib"
            NO_DEFAULT_PATH
        )

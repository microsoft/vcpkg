...
function("${VCPKG_OVERRIDE_FIND_PACKAGE_NAME}")
    ...
    if(DEFINED Z_VCPKG_DISABLE_PACKAGES)
        ...
        if("${PACKAGE_NAME}" IN_LIST Z_VCPKG_DISABLE_PACKAGES)
            set(CMAKE_DISABLE_FIND_PACKAGE_${PACKAGE_NAME} 1)
        endif()
    endif()
    if(DEFINED Z_VCPKG_REQUIRE_ALL_PACKAGES)
        cmake_policy(SET CMP0057 NEW)
        if(NOT CMAKE_DISABLE_FIND_PACKAGE_${PACKAGE_NAME} AND NOT "REQUIRED" IN_LIST ARGS AND NOT "${PACKAGE_NAME}" IN_LIST Z_VCPKG_OPTIONAL_PACKAGES)

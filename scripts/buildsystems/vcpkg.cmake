...
function(vcpkg_add_sourcelink_link_options target)
    if(MSVC AND CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL "19.15.26726.0")
        ...
        if(VCPKG_SOURCELINK_FILE)
            set_property(TARGET ${target} APPEND PROPERTY LINK_LIBRARIES "-sourcelink:${VCPKG_SOURCELINK_FILE}")
        endif()
        ...
        if(SOURCELINK_FILES)
            foreach(SOURCELINK_FILE ${SOURCELINK_FILES})
                set_property(TARGET ${target} APPEND PROPERTY LINK_LIBRARIES "-sourcelink:${SOURCELINK_FILE}")
            endforeach()
        endif()
    endif()
endfunction()

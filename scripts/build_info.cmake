...
if (DEFINED VCPKG_POLICY_SKIP_DLL_ARCHITECTURE_CHECK)
    file(APPEND ${BUILD_INFO_FILE_PATH} "PolicySkipDLLArchitectureCheck: ${VCPKG_POLICY_SKIP_DLL_ARCHITECTURE_CHECK}\n")
endif()

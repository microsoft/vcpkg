...
if (DEFINED VCPKG_POLICY_SKIP_PKGCONFIG_LOCATION_CHECK)
    file(APPEND ${BUILD_INFO_FILE_PATH} "PolicySkipPkgConfigLocationCheck: ${VCPKG_POLICY_SKIP_PKGCONFIG_LOCATION_CHECK}\n")
endif()

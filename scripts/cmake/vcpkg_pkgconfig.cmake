		...
		foreach(_pkc_package ${_pkc_PACKAGES})
			...
			foreach(_pkc_elem ${_pkc_PKGCONFIG_SYSTEMLIBS})
				...
				if (${_pkc_elem} IN_LIST VCPKG_SYSTEM_LIBRARIES)
					...
					foreach(index RANGE 0 ${_pkc_possible_lib_prefix_count})
						list(GET VCPKG_FIND_LIBRARY_PREFIXES ${index} _pr)
						set(_test_lib_file "${CURRENT_INSTALLED_DIR}${_pkc_path_extra_subdir}/lib/${_pr}${_pkc_elem}${VCPKG_TARGET_IMPORT_LIBRARY_SUFFIX}")

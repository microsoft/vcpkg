...
function(vcpkg_fixup_pkgconfig_check_files pkg_cfg_cmd _file _config _system_libs _ignore_flags)
    ...
    if(ENV{PKG_CONFIG_PATH})
        ...
        set(ENV{PKG_CONFIG_PATH} "${PKGCONFIG_INSTALLED_DIR}${SEP}${PKGCONFIG_INSTALLED_SHARE_DIR}${SEP}${PKGCONFIG_PACKAGES_DIR}${SEP}${PKGCONFIG_PACKAGES_SHARE_DIR}${SEP}$ENV{PKG_CONFIG_PATH}")
    else()
        set(ENV{PKG_CONFIG_PATH} "${PKGCONFIG_INSTALLED_DIR}${SEP}${PKGCONFIG_INSTALLED_SHARE_DIR}${SEP}${PKGCONFIG_PACKAGES_DIR}${SEP}${PKGCONFIG_PACKAGES_SHARE_DIR}")
    endif()

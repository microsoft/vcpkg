...
Halting portfile execution.
    ...
    vcpkg_list(SET unique_log_filenames)
    foreach(logfile IN LISTS arg_SAVE_LOG_FILES)
        ...
        set(unique_count 1)
        while(filename IN_LIST unique_log_filenames)
            math(EXPR unique_count "${unique_count} + 1")
            string(REGEX REPLACE [[(-\d*)?\.log$]] "-${unique_count}.log" filename "${filename}")
        endwhile()
        vcpkg_list(APPEND unique_log_filenames "${filename}")

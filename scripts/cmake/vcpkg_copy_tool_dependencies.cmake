...
function(z_vcpkg_find_dependency_tool)
    ...
    if (dumpbin_executable_)
        set(${z_vcpkg_find_dependency_tool_DEPENDENCY_TOOL_RESULT} "${dumpbin_executable_}" PARENT_SCOPE)
        set(${z_vcpkg_find_dependency_tool_PARTIAL_DEPENDENCY_TOOL_COMMAND_RESULT} "/DEPENDENTS" PARENT_SCOPE)
        set(${z_vcpkg_find_dependency_tool_REGEX_RESULT} "[ \t][ \t][ \t][ \t][^ \t\r\n]+\\.dll" PARENT_SCOPE)
        set(${z_vcpkg_find_dependency_tool_REPLACE_RESULT} "[ \t][ \t][ \t][ \t]" PARENT_SCOPE)
        set(${z_vcpkg_find_dependency_tool_SUCCESS_RESULT} TRUE PARENT_SCOPE)
    elseif (llvm_objdump_executable_)
        set(${z_vcpkg_find_dependency_tool_DEPENDENCY_TOOL_RESULT} "${llvm_objdump_executable_}" PARENT_SCOPE)
    ...
    elseif (objdump_executable_)
        set(${z_vcpkg_find_dependency_tool_DEPENDENCY_TOOL_RESULT} "${objdump_executable_}" PARENT_SCOPE)
        set(${z_vcpkg_find_dependency_tool_PARTIAL_DEPENDENCY_TOOL_COMMAND_RESULT} "-p" PARENT_SCOPE)
        set(${z_vcpkg_find_dependency_tool_REGEX_RESULT} "DLL Name: [^\r\n]*\.dll" PARENT_SCOPE)
        set(${z_vcpkg_find_dependency_tool_REPLACE_RESULT} "DLL Name: " PARENT_SCOPE)
        set(${z_vcpkg_find_dependency_tool_SUCCESS_RESULT} TRUE PARENT_SCOPE)
...
function(z_vcpkg_get_object_dependencies)
    ...
    set(one_value_args_ MATCH_REGEX REPLACE_REGEX DEPENDENCIES_RESULT SUCCESS_RESULT ERROR_MESSAGES_RESULT)
    set(multi_value_args_ DEPENDENCY_COMMAND)
    cmake_parse_arguments(z_vcpkg_get_object_dependencies "" "${one_value_args_}" "${multi_value_args_}" ${ARGN})
    ...
    execute_process(
        COMMAND ${z_vcpkg_get_object_dependencies_DEPENDENCY_COMMAND}
...
function(vcpkg_resolve_deploy_object_dependencies)
    ...
    if (NOT dependency_tool_success_)
        message(FATAL_ERROR "vcpkg_resolve_deploy_object_dependencies: Could not find dependency tool")
        set(${vcpkg_resolve_deploy_object_dependencies_SUCCESS_RESULT} FALSE PARENT_SCOPE)
    endif()

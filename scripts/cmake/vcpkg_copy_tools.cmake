...
function(vcpkg_copy_tools)
    ...
    foreach(tool_name ${_vct_TOOL_NAMES})
        ...
        if(EXISTS "${tool_path}")
            ...
            if(EXISTS "${_vct_SEARCH_DIR}/${tool_name}.pdb")
                file(COPY "${_vct_SEARCH_DIR}/${tool_name}.pdb" DESTINATION "${CURRENT_PACKAGES_DIR}/tools/${PORT}")
                if(_vct_AUTO_CLEAN)
                    file(REMOVE "${_vct_SEARCH_DIR}/${tool_name}.pdb")
                endif()
            endif()
        else()

    ...
    foreach(build_type IN ITEMS debug release)
        ...
        if(CMAKE_HOST_UNIX)
            if(DEFINED ENV{LD_LIBRARY_PATH})
                ...
                vcpkg_host_path_list(APPEND ENV{LD_LIBRARY_PATH} "${current_installed_prefix}/lib/")
                vcpkg_host_path_list(APPEND ENV{LD_LIBRARY_PATH} "${current_installed_prefix}/lib/manual-link/")
                foreach(current_path IN ITEMS ${ld_library_path_backup})
                    vcpkg_host_path_list(APPEND ENV{LD_LIBRARY_PATH} "${current_path}")
                endforeach()
            else()

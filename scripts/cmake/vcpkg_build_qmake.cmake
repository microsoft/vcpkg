    ...
    foreach(build_type IN ITEMS debug release)
        ...
        if(CMAKE_HOST_UNIX)
            if(DEFINED ENV{LD_LIBRARY_PATH})
                ...
                vcpkg_host_path_list(SET ENV{LD_LIBRARY_PATH} "${current_installed_libpath}" "${ld_library_path_backup}")
            else()
                unset(ld_library_path_backup)
                vcpkg_host_path_list(SET ENV{LD_LIBRARY_PATH} "${current_installed_libpath}")
            endif()
        endif()

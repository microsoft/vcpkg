...
function(vcpkg_find_acquire_program program)
    ...
    elseif(program STREQUAL "PYTHON2")
        if(CMAKE_HOST_WIN32)
            ...
            if(EXISTS "${CURRENT_HOST_INSTALLED_DIR}/share/vcpkg-tool-python2/version.txt")
                file(READ "${CURRENT_HOST_INSTALLED_DIR}/share/vcpkg-tool-python2/version.txt" program_version)
                set(paths_to_search "${CURRENT_HOST_INSTALLED_DIR}/tools/vcpkg-tool-python2")
            else() # Old behavior
                if (VCPKG_TARGET_ARCHITECTURE STREQUAL x86)
                    set(tool_subdirectory "python-${program_version}-x86")

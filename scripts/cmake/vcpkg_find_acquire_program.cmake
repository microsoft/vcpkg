...
function(z_vcpkg_find_acquire_program_set_variables variables_array out_var_out_variables)
  ...
  message(STATUS "PROGNAME for ${VAR}: ${PROGNAME}")
...
function(vcpkg_find_acquire_program VAR)
  ...
  elseif(VAR MATCHES "PYTHON2")
    if(CMAKE_HOST_WIN32)
      ...
      if (VCPKG_TARGET_ARCHITECTURE STREQUAL x86)
        set(SUBDIR "python-${PROGRAM_VERSION}-x86")
        ...
        set(SUBDIR "python-${PROGRAM_VERSION}-x64")
  ...
  elseif(VAR MATCHES "RUBY")
    ...
    set(PATHS ${DOWNLOADS}/tools/ruby/rubyinstaller-${PROGRAM_VERSION}-x86/bin)
  ...
  elseif(VAR MATCHES "NINJA")
    ...
    if(CMAKE_HOST_WIN32)
      ...
      set(SUBDIR "${PROGRAM_VERSION}-windows")
    ...
    elseif(CMAKE_HOST_SYSTEM_NAME STREQUAL "Darwin")
      ...
      set(SUBDIR "${PROGRAM_VERSION}-osx")
      set(PATHS "${DOWNLOADS}/tools/ninja-${PROGRAM_VERSION}-osx")
    ...
    elseif(CMAKE_HOST_SYSTEM_NAME STREQUAL "FreeBSD")
      ...
      set(SUBDIR "${PROGRAM_VERSION}-linux")
      set(PATHS "${DOWNLOADS}/tools/ninja-${PROGRAM_VERSION}-linux")
  ...
  elseif(VAR MATCHES "NUGET")
    ...
    set(final_program_name "nuget.exe")
  ...
  elseif(VAR MATCHES "MESON")
    ...
    #set(PATHS ${DOWNLOADS}/tools/meson/meson-${PROGRAM_VERSION})
  ...
  elseif(VAR MATCHES "GASPREPROCESSOR")
    ...
    set(final_program_name "gas-preprocessor.pl")
  ...
  elseif(VAR MATCHES "SWIG")
    ...
    if(CMAKE_HOST_WIN32)
      ...
      set(SUBDIR b8f105f9b9-f0518bc3b7/swigwin-${PROGRAM_VERSION})
    else()
  ...
  elseif(VAR MATCHES "BAZEL")
    set(PROGNAME bazel)
    set(PROGRAM_VERSION 4.1.0)
    set(final_program_name "bazel")
    if(CMAKE_HOST_SYSTEM_NAME STREQUAL "Linux")
      set(_vfa_SUPPORTED ON)
      set(SUBDIR ${PROGRAM_VERSION}-linux)
      set(URL "https://github.com/bazelbuild/bazel/releases/download/${PROGRAM_VERSION}/bazel-${SUBDIR}-x86_64")
    ...
    elseif(CMAKE_HOST_SYSTEM_NAME STREQUAL "Darwin")
      set(_vfa_SUPPORTED ON)
      set(SUBDIR ${PROGRAM_VERSION}-darwin)
      set(URL "https://github.com/bazelbuild/bazel/releases/download/${PROGRAM_VERSION}/bazel-${SUBDIR}-x86_64")
      set(ARCHIVE "bazel-${SUBDIR}-x86_64")
      set(NOEXTRACT ON)
      ...
      set(SUBDIR ${PROGRAM_VERSION}-windows)
      set(URL "https://github.com/bazelbuild/bazel/releases/download/${PROGRAM_VERSION}/bazel-${SUBDIR}-x86_64.zip")
  ...
  elseif(VAR MATCHES "PKGCONFIG")
    ...
    elseif(CMAKE_HOST_SYSTEM_NAME STREQUAL "OpenBSD")
      ...
      set(_vfa_SUPPORTED ON)
      set(final_program_name "pkg-config")

...
#        set(SUBDIR "python-3.7.3-x86")
        set(URL "https://globalcdn.nuget.org/packages/pythonx86.3.7.3.nupkg")#/package/7-Zip.CommandLine/18.1.0
...
#      set(POST_INSTALL_COMMAND ${CMAKE_COMMAND} -E remove python37._pth)
      find_program(Python3_EXECUTABLE NAMES python python3 python3.7 NAMES_PER_DIR HINTS ${PATHS} NO_DEFAULT_PATH)
  ...
  elseif(VAR MATCHES "NUGET")
    ...
    if(CMAKE_HOST_WIN32)
      find_program(NUGET_EXECUTABLE NAMES nuget NAMES_PER_DIR HINTS ${PATHS} NO_DEFAULT_PATH)
      vcpkg_add_to_path(PREPEND ${PATHS})
      find_package_handle_standard_args(NUGET DEFAULT_MSG NUGET_EXECUTABLE)

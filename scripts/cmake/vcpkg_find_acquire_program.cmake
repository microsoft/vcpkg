...
function(vcpkg_find_acquire_program program)
    ...
    elseif(program MATCHES "NUGET")
        ...
        set(download_urls "https://dist.nuget.org/win-x86-commandline/v5.10.0/nuget.exe")
        set(rename_binary_to "nuget.exe")
        set(download_filename "nuget.5.10.0.exe")
        set(raw_executable ON)
        set(download_sha512 c4b7375e46cdb843096ce491b9809e0dc86773ba7b6333f13d49ec414b2953112df82ee8b833fd31be0cc7fe0fff1af88f3c07aa9553ad03f7f6c5a6eec2057e)

...
function(vcpkg_find_acquire_program program)
    ...
    elseif(program STREQUAL "PATCHELF")
        ...
        set(version_command --version)
    elseif(program STREQUAL "TCL")
        set(program_name tcl)
        if (CMAKE_HOST_WIN32)
            set(program_version 8.6.7)
            set(download_filename "irontcl-win32-${program_version}.zip")
            set(download_urls "https://www.irontcl.com/downloads/${download_filename}")
            set(tool_subdirectory "${program_version}-irontcl")
            set(paths_to_search "${DOWNLOADS}/tools/tcl/${tool_subdirectory}/IronTcl/bin")
            set(download_sha512 "cf7a124d96392592a1301e8cc788b70a40903261ebd3b9cc43dd4aab7a96d0990cfa89902cf6063c5304ae8f7944d3a07407286d2c6c8d4e30abfad810ccc224")
            set(search_names "tclsh86t")
        else()
            set(brew_package_name tcl-tk)
            set(apt_package_name tcl)
            set(paths_to_search "/bin" "/usr/bin" "/usr/local/bin")
            set(search_names "tclsh")
        endif()
        set(version_command --version)
    else()

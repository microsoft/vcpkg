...
function(vcpkg_find_acquire_program VAR)
  ...
  elseif(VAR MATCHES "PKG-CONFIG")
    set(PROGNAME pkg-config)
    set(SUBDIR "pkg-config-lite-0.28-1")
    set(PATHS ${DOWNLOADS}/tools/pkg-config/${SUBDIR}/bin)
    set(URL "https://sourceforge.net/projects/pkgconfiglite/files/0.28-1/pkg-config-lite-0.28-1_bin-win32.zip/download")
    set(ARCHIVE "pkg-config-lite-0.28-1_bin-win32.zip")
    set(HASH d25622397781ece3057312645286ee7cc464b6d6029aea8f95e027477058d75f5b405f471c94dc071cd17b5c44409348214d7dc92fd5cecde43d6d9076de1ee3)
  else()

...
function(vcpkg_find_acquire_program VAR)
  ...
  elseif(VAR MATCHES "MESON")
    if(NOT CMAKE_HOST_APPLE)
      ...
      set(PIP3_PACKAGE_NAME "meson")
      if(CMAKE_HOST_WIN32)
        set(SCRIPTNAME meson.py)
      else()
        set(SCRIPTNAME meson)
      endif()
      set(PATHS ${DOWNLOADS}/tools/meson/meson-0.54.3)
      set(URL "https://github.com/mesonbuild/meson/archive/0.54.3.zip")
      set(ARCHIVE "meson-0.54.3.zip")
      set(HASH 908c4645793d99343a4cc8a0e7c38947977ccdecc3401e9d084018956d26c4ab426b6ae34daa5440ee2b97c3907cb251b18b513b3ba7b739411aac7deba9718a)
    else()
      set(PROGNAME meson)
  ...
  if("${${VAR}}" MATCHES "-NOTFOUND")
    if(NOT CMAKE_HOST_SYSTEM_NAME STREQUAL "Windows" AND NOT _vfa_SUPPORTED)
      ...
      elseif(DEFINED PIP3_PACKAGE_NAME)
        set(EXAMPLE ":\n    sudo pip3 install ${PIP3_PACKAGE_NAME}")
      endif()

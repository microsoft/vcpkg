...
function(vcpkg_find_acquire_program VAR)
  ...
  elseif(VAR MATCHES "GIT")
    set(PROGNAME git)
    if(CMAKE_HOST_WIN32)
      set(SUBDIR "git-2.26.1-1-windows")
      set(URL "https://github.com/git-for-windows/git/releases/download/v2.26.1.windows.1/PortableGit-2.26.1-32-bit.7z.exe")
      set(ARCHIVE "PortableGit-2.26.1-32-bit.7z.exe")
      set(HASH fa3074a770b21adb0f88ff64e2ed1a8f20212a6ae288e4f00f102459fa6ec218b60f5532d2b691cfd80564368c5d420fac352301160891bf8cd1907d08025db0)
      set(PATHS 

...
function(vcpkg_find_acquire_program VAR)
  ...
  elseif(VAR MATCHES "NINJA")
    ...
    set(URL "https://github.com/ninja-build/ninja/releases/download/v${VERSION}/ninja-win.zip")
    set(ARCHIVE "ninja-win-${VERSION}.zip")
  ...
  macro(do_find)
    if(NOT DEFINED REQUIRED_INTERPRETER)
      ...
      if(NOT ${VAR})
        ...
        if(${VAR} AND NOT VERSION_CHECKED)
            do_version_check()
            set(VERSION_CHECKED ON)
        elseif(VERSION_CHECKED)
            message(FATAL_ERROR "Unable to find ${PROGNAME} with min version of ${VERSION}")
        endif()
      endif()
    else()

...
function(vcpkg_find_acquire_program VAR)
  ...
  elseif(VAR MATCHES "GN")
    set(PROGNAME gn)
    set(_vfa_RENAME "gn")
    set(GN_VERSION "2021-05-07") # https://gn.googlesource.com/gn/+/39a87c0b36310bdf06b692c098f199a0d97fc810
    set(CIPD_DOWNLOAD_GN "https://chrome-infra-packages.appspot.com/dl/gn/gn")
    # To find new builds, see: https://chrome-infra-packages.appspot.com/p/gn/gn.
    if(CMAKE_HOST_SYSTEM_NAME STREQUAL "Linux")
      set(_vfa_SUPPORTED ON)
      set(GN_INSTANCE_ID "TEQA2BwAc08bDs0UtkrDd43ZOdKdgH8TvQijwfjdxIsC")
      set(GN_PLATFORM "linux-amd64")
      set(HASH "546f8b9f85c3aa584f19e54c46ff2dc6ee0682697c2bce3e981162c0c4b025057d6797fa5b5a631519318a54819a526092c2210e6781d5a1a17717eddac47289")
    elseif(CMAKE_HOST_SYSTEM_NAME STREQUAL "Darwin")
      set(_vfa_SUPPORTED ON)
      set(GN_INSTANCE_ID "Mbl8f0TWCoa1PPYTeYW0ah24ngTpHRrVVUF3oTnlcWsC")
      set(GN_PLATFORM "mac-amd64")
      set(HASH "2b76af30f651354435a0014ef5b05061c16530d34a018cfd7d1a6e9eb4983b9ab9910e96160a4e915a734297c027e870bf7461b92bb4235a7acfba880325c97b")
    else()
      set(GN_INSTANCE_ID "JN60Ob6tfr2heL_HH5OXLaoDxVA2Ps6JppwKH6a5YHEC")
      set(GN_PLATFORM "windows-amd64")
      set(HASH "dfa4efe61bfd0540a1727e020b14a9052e0b05a8de9512739e8dcecfb7b76645098a38d2e4d05d8e58f2d0efead82aaee5c5adeeaa1f2efeee4713b9db8c0ac4")
    endif()
    set(SUBDIR "${GN_INSTANCE_ID}")
    set(URL "${CIPD_DOWNLOAD_GN}/${GN_PLATFORM}/+/${GN_INSTANCE_ID}")
    set(ARCHIVE "gn-${GN_PLATFORM}-${GN_VERSION}.zip")

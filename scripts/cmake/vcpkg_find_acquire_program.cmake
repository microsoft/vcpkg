...
function(vcpkg_find_acquire_program VAR)
  ...
  elseif(VAR MATCHES "GIT")
    ...
    if(CMAKE_HOST_WIN32)
      ...
      set(HASH 1071b07c6c55674eb408e0f883079a849bb6a766f1d0a1fea65e8599082e87edb1dbe5e57eae279a60fdbb7268a8da765cc7e83c502268283a143e1640ce72b1)
      set(PATHS
  ...
  elseif(VAR MATCHES "GO")
    ...
    set(HASH 43cd656bea09b380e9054b5272d2f96502ab4569a2bfdcf8dda2485d35b2fb22f536f1675d1a912942b26439e95c451266c9b31533a3962a7bced64b018428ee)
  ...
  elseif(VAR MATCHES "RUBY")
    ...
    set(HASH 227bcbb7a36e1e16d7b9df1f2c2117c7139734e6ac8c8309e1cf0f29094ed379e1bf10ad45dd962608bfe7359fb840d08cfb1b3de057d645e98b2a0b3e4824be)
  ...
  elseif(VAR MATCHES "NODE")
    if(CMAKE_HOST_WIN32)
      ...
      set(SUBDIR "v${NODE_VERSION}")
      set(PATHS ${DOWNLOADS}/tools/nodejs/${SUBDIR}/node-${SUBDIR}-win-x86)
      set(URL "https://nodejs.org/dist/${SUBDIR}/node-${SUBDIR}-win-x86.zip")
      set(ARCHIVE "nodejs-${SUBDIR}.zip")

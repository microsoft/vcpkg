...
function(vcpkg_build_make)
    ...
    if (_VCPKG_MAKE_OPTIONS_DEBUG STREQUAL _VCPKG_MAKE_OPTIONS_RELEASE OR _VCPKG_INSTALL_OPTIONS_DEBUG STREQUAL _VCPKG_INSTALL_OPTIONS_RELEASE)
    ...
    if (_bc_ENABLE_INSTALL)
        foreach(BUILDTYPE "debug" "release")
            if(BUILDTYPE STREQUAL "debug")
                ...
                # Add options
                if (CMAKE_HOST_WIN32)
                    set(INSTALL_OPTS ${INSTALL_OPTS_BASE} ${_VCPKG_INSTALL_OPTIONS_DEBUG})
                else()
                    set(INSTALL_OPTS ${INSTALL_OPTS_BASE};${_VCPKG_INSTALL_OPTIONS_DEBUG})
                endif()
            else()
                ...
                # Add options
                if (CMAKE_HOST_WIN32)
                    set(INSTALL_OPTS ${INSTALL_OPTS_BASE} ${_VCPKG_INSTALL_OPTIONS_RELEASE})
                else()
                    set(INSTALL_OPTS ${INSTALL_OPTS_BASE};${_VCPKG_INSTALL_OPTIONS_RELEASE})
                endif()
            endif()

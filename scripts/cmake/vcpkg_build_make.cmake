...
function(vcpkg_build_make)
    cmake_parse_arguments(_bc "ADD_BIN_TO_PATH;ENABLE_INSTALL" "LOGFILE_ROOT" "MAKE_OPTIONS" ${ARGN})
    ...
    if (_VCPKG_MAKE_GENERATOR STREQUAL "make")
        if (CMAKE_HOST_WIN32)
            ...
            set(MAKE_COMMAND ${MAKE})
            # Set make command and install command
            set(MAKE_OPTS ${_bc_MAKE_OPTIONS} -j ${VCPKG_CONCURRENCY} -f makefile all)
            set(INSTALL_OPTS -j ${VCPKG_CONCURRENCY} --trace install)
        endif()
    ...
    if(NOT VCPKG_TARGET_IS_WINDOWS)
        ...
        string(APPEND C_FLAGS_GLOBAL "/showIncludes")
        string(APPEND CXX_FLAGS_GLOBAL "/showIncludes")
    endif()

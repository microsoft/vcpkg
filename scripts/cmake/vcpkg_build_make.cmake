...
function(vcpkg_build_make)
    ...
    if (_VCPKG_MAKE_GENERATOR STREQUAL "make")
        if (CMAKE_HOST_WIN32)
            ...
            set(MAKE_OPTS "${_bc_MAKE_OPTIONS} -j ${VCPKG_CONCURRENCY}")
            set(INSTALL_OPTS "install -j ${VCPKG_CONCURRENCY} --trace")
        else()
            # Compiler requriements
            set(MAKE_BASH)
            ...
            set(MAKE_COMMAND ${MAKE})
            # Set make command and install command
            set(MAKE_OPTS -j ${VCPKG_CONCURRENCY} -f makefile all ${_bc_MAKE_OPTIONS})

...
function(vcpkg_build_make)
    ...
    if(WIN32)
        set(Z_VCPKG_PREFIX ${CURRENT_PACKAGES_DIR})
        set(Z_VCPKG_INSTALLED ${CURRENT_INSTALLED_DIR})
    else()
        string(REPLACE " " "\ " Z_VCPKG_PREFIX "${CURRENT_PACKAGES_DIR}")
    ...
    if (CMAKE_HOST_WIN32)
        ...
        string(REPLACE " " "\\\ " Z_VCPKG_PACKAGE_PREFIX ${CURRENT_PACKAGES_DIR})
        string(REGEX REPLACE "([a-zA-Z]):/" "/\\1/" Z_VCPKG_PACKAGE_PREFIX "${Z_VCPKG_PACKAGE_PREFIX}")
        set(install_opts -j ${VCPKG_CONCURRENCY} --trace -f ${arg_MAKEFILE} ${arg_INSTALL_TARGET} DESTDIR=${Z_VCPKG_PACKAGE_PREFIX})

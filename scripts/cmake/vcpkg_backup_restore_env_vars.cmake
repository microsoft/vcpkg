...
macro(z_vcpkg_forward_backup_env_variables)
    foreach(zvfbv_envvar IN ITEMS ${ARGN})
        message(STATUS "z_vcpkg_env_backup_${zvfbv_envvar} := ${z_vcpkg_env_backup_${zvfbv_envvar}}")
        if(DEFINED z_vcpkg_env_backup_${zvfbv_envvar})
            set("z_vcpkg_env_backup_${zvfbv_envvar}" "${z_vcpkg_env_backup_${zvfbv_envvar}}" PARENT_SCOPE)
        else()
            unset("z_vcpkg_env_backup_${zvfbv_envvar}" PARENT_SCOPE)
        endif()
    endforeach()
endmacro()

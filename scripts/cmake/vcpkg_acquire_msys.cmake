...
function(vcpkg_acquire_msys PATH_TO_ROOT_OUT)
  ...
  macro(msys_package)
    cmake_parse_arguments(p "ZST;ANY;SILENT" "URL;NAME;SHA512;VERSION;REPO" "DEPS" ${ARGN})
    if(p_URL AND NOT p_NAME)
      if (p_URL MATCHES "^http.+$")
        message(FATAL_ERROR "Please remove \"https://\" or \"http://\" from the URL")
      endif()
      if(NOT p_URL MATCHES "^repo\\.msys2\\.org/.*/(([^-]+(-[^0-9][^-]*)*)-.+\\.pkg\\.tar\\.(xz|zst))\$")
    ...
    if("${p_NAME}" IN_LIST PACKAGES)
      ...
      if (NOT download_success AND URL_PREFIX STREQUAL "https://")
  ...
  msys_package(
    URL "repo.msys2.org/msys/x86_64/unzip-6.0-2-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "repo.msys2.org/msys/x86_64/libbz2-1.0.8-2-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "repo.msys2.org/msys/x86_64/patch-2.7.6-1-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "repo.msys2.org/msys/x86_64/gzip-1.10-1-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "repo.msys2.org/msys/x86_64/bash-4.4.023-2-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "repo.msys2.org/msys/x86_64/autoconf-2.69-5-any.pkg.tar.xz"
  ...
  msys_package(
    URL "repo.msys2.org/msys/x86_64/diffutils-3.7-1-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "repo.msys2.org/msys/x86_64/binutils-2.34-4-x86_64.pkg.tar.zst"
  ...
  msys_package(
    URL "repo.msys2.org/msys/x86_64/libtool-2.4.6-9-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "repo.msys2.org/msys/x86_64/coreutils-8.32-1-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "repo.msys2.org/msys/x86_64/grep-3.0-2-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "repo.msys2.org/msys/x86_64/sed-4.8-1-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "repo.msys2.org/msys/x86_64/libpcre-8.44-1-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "repo.msys2.org/msys/x86_64/m4-1.4.18-2-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "repo.msys2.org/msys/x86_64/automake-wrapper-11-1-any.pkg.tar.xz"
  ...
  msys_package(
    URL "repo.msys2.org/msys/x86_64/gawk-5.1.0-1-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "repo.msys2.org/msys/x86_64/mpfr-4.1.0-1-x86_64.pkg.tar.zst"
  ...
  msys_package(
    URL "repo.msys2.org/msys/x86_64/gmp-6.2.0-1-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "repo.msys2.org/msys/x86_64/libreadline-8.0.004-1-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "repo.msys2.org/msys/x86_64/ncurses-6.2-1-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "repo.msys2.org/msys/x86_64/automake1.16-1.16.2-1-any.pkg.tar.zst"
  ...
  msys_package(
    URL "repo.msys2.org/msys/x86_64/perl-5.32.0-1-x86_64.pkg.tar.zst"
  ...
  msys_package(
    URL "repo.msys2.org/msys/x86_64/libcrypt-2.1-2-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "repo.msys2.org/msys/x86_64/pkg-config-0.29.2-1-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "repo.msys2.org/msys/x86_64/make-4.3-1-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "repo.msys2.org/msys/x86_64/libintl-0.19.8.1-1-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "repo.msys2.org/msys/x86_64/libiconv-1.16-1-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "repo.msys2.org/msys/x86_64/gcc-libs-9.3.0-1-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "repo.msys2.org/msys/x86_64/msys2-runtime-3.1.6-3-x86_64.pkg.tar.xz"

...
function(vcpkg_acquire_msys PATH_TO_ROOT_OUT)
  ...
  macro(msys_package)
    cmake_parse_arguments(p "ZST;ANY;SILENT;NO_SSL" "URL;NAME;SHA512;VERSION;REPO" "DEPS" ${ARGN})
    if (p_NO_SSL)
        set(URL_PREFIX http://)
    else()
    ...
    if(p_URL AND NOT p_NAME)
      if(NOT p_URL MATCHES "^${URL_PREFIX}repo\\.msys2\\.org/.*/(([^-]+(-[^0-9][^-]*)*)-.+\\.pkg\\.tar\\.(xz|zst))\$")
      ...
      set(p_URL "${URL_PREFIX}repo.msys2.org/${p_REPO}/${FILENAME}")
    endif()
    if (p_SILENT)
        set(DOWNLOAD_SILENT SILENT_EXIT)
    else()
        set(DOWNLOAD_SILENT )
    endif()
  ...
  set(MSYS_PACKAGE_ADDRESS repo.msys2.org/msys/x86_64)
  set(MSYS_PACKAGE_URl_PREFIX ${HTTPS_PREFIX}${MSYS_PACKAGE_ADDRESS})
  set(NOT_USE_SSL )
  # Try to use https first
  msys_package(
    URL "${MSYS_PACKAGE_URl_PREFIX}/unzip-6.0-2-x86_64.pkg.tar.xz"
  ...
  if (NOT download_success)
    ...
    set(MSYS_PACKAGE_URl_PREFIX ${HTTP_PREFIX}${MSYS_PACKAGE_ADDRESS})
    set(NOT_USE_SSL NO_SSL)
    msys_package(
        URL "${MSYS_PACKAGE_URl_PREFIX}/unzip-6.0-2-x86_64.pkg.tar.xz"
        SHA512 b8a1e0ce6deff26939cb46267f80ada0a623b7d782e80873cea3d388b4dc3a1053b14d7565b31f70bc904bf66f66ab58ccc1cd6bfa677065de1f279dd331afb9
        DEPS libbz2
  ...
  msys_package(
    URL "${MSYS_PACKAGE_URl_PREFIX}/libbz2-1.0.8-2-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "${MSYS_PACKAGE_URl_PREFIX}/patch-2.7.6-1-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "${MSYS_PACKAGE_URl_PREFIX}/gzip-1.10-1-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "${MSYS_PACKAGE_URl_PREFIX}/bash-4.4.023-2-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "${MSYS_PACKAGE_URl_PREFIX}/autoconf-2.69-5-any.pkg.tar.xz"
  ...
  msys_package(
    URL "${MSYS_PACKAGE_URl_PREFIX}/diffutils-3.7-1-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "${MSYS_PACKAGE_URl_PREFIX}/binutils-2.34-4-x86_64.pkg.tar.zst"
  ...
  msys_package(
    URL "${MSYS_PACKAGE_URl_PREFIX}/libtool-2.4.6-9-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "${MSYS_PACKAGE_URl_PREFIX}/coreutils-8.32-1-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "${MSYS_PACKAGE_URl_PREFIX}/grep-3.0-2-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "${MSYS_PACKAGE_URl_PREFIX}/sed-4.8-1-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "${MSYS_PACKAGE_URl_PREFIX}/libpcre-8.44-1-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "${MSYS_PACKAGE_URl_PREFIX}/m4-1.4.18-2-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "${MSYS_PACKAGE_URl_PREFIX}/automake-wrapper-11-1-any.pkg.tar.xz"
  ...
  msys_package(
    URL "${MSYS_PACKAGE_URl_PREFIX}/gawk-5.1.0-1-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "${MSYS_PACKAGE_URl_PREFIX}/mpfr-4.1.0-1-x86_64.pkg.tar.zst"
  ...
  msys_package(
    URL "${MSYS_PACKAGE_URl_PREFIX}/gmp-6.2.0-1-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "${MSYS_PACKAGE_URl_PREFIX}/libreadline-8.0.004-1-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "${MSYS_PACKAGE_URl_PREFIX}/ncurses-6.2-1-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "${MSYS_PACKAGE_URl_PREFIX}/automake1.16-1.16.2-1-any.pkg.tar.zst"
  ...
  msys_package(
    URL "${MSYS_PACKAGE_URl_PREFIX}/automake1.15-1.15.1-1-any.pkg.tar.xz"
  ...
  msys_package(
    URL "${MSYS_PACKAGE_URl_PREFIX}/perl-5.32.0-1-x86_64.pkg.tar.zst"
  ...
  msys_package(
    URL "${MSYS_PACKAGE_URl_PREFIX}/libcrypt-2.1-2-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "${MSYS_PACKAGE_URl_PREFIX}/pkg-config-0.29.2-1-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "${MSYS_PACKAGE_URl_PREFIX}/make-4.3-1-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "${MSYS_PACKAGE_URl_PREFIX}/libintl-0.19.8.1-1-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "${MSYS_PACKAGE_URl_PREFIX}/libiconv-1.16-1-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "${MSYS_PACKAGE_URl_PREFIX}/gcc-libs-9.3.0-1-x86_64.pkg.tar.xz"
  ...
  msys_package(
    URL "${MSYS_PACKAGE_URl_PREFIX}/msys2-runtime-3.1.6-3-x86_64.pkg.tar.xz"

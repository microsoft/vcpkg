...
function(vcpkg_check_build_output)
    ...
    foreach(cbo_file IN LISTS _cbo_LOGFILES)
        ...
        message(STATUS "VCPKG-check-build-output: Searching for invalid ${_vcpkg_check_searchpath3}")
        string(FIND "${_cbo_contents}" "${_vcpkg_check_searchpath}" _cbo_found)
        string(FIND "${_cbo_contents}" "${_vcpkg_check_searchpath2}" _cbo_found2)
        string(FIND "${_cbo_contents}" "${_vcpkg_check_searchpath2}" _cbo_found3)
        ...
        elseif(NOT ${_cbo_found2} EQUAL -1)
            message(FATAL_ERROR "VCPKG-check-build-output: Found wrong path in build output: file:${cbo_file} line:${_cbo_found2}! Please investigate and fix library linkage")
        elseif(NOT ${_cbo_found3} EQUAL -1)
            message(FATAL_ERROR "VCPKG-check-build-output: Found wrong path in build output: file:${cbo_file} line:${_cbo_found3}! Please investigate and fix library linkage")
        else()

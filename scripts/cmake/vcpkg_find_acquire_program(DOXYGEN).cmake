...
if(CMAKE_HOST_WIN32)
    set(download_urls "https://github.com/doxygen/doxygen/releases/download/${program_version_dir}/doxygen-${program_version}.windows.x64.bin.zip")
    ...
    set(paths_to_search "${DOWNLOADS}/tools/doxygen/doxygen-${program_version}")
elseif(VCPKG_HOST_IS_LINUX)
    execute_process(COMMAND uname -m OUTPUT_VARIABLE HOST_ARCH OUTPUT_STRIP_TRAILING_WHITESPACE)
    if(HOST_ARCH MATCHES "x86_64|amd64")
        set(download_urls "https://github.com/doxygen/doxygen/releases/download/${program_version_dir}/doxygen-${program_version}.linux.bin.tar.gz")

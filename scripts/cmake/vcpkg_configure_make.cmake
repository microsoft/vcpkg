...
macro(_vcpkg_extract_cpp_flags_and_set_cflags_and_cxxflags _SUFFIX _FOR_BUILD)
    ...
    string(APPEND CFLAGS_${VAR_SUFFIX} " ${INCLUDE_SYSTEM_FLAG_C}${VCPKG_INCLUDE_PATH}")
    string(APPEND CXXFLAGS_${VAR_SUFFIX} " ${INCLUDE_SYSTEM_FLAG_CXX}${VCPKG_INCLUDE_PATH}")

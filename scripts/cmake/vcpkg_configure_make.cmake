    ...
    foreach(_buildtype IN LISTS _buildtypes)
        ...
        foreach(_lib_env_var IN LISTS _lib_env_vars)
            ...
            if(EXISTS "${_VCPKG_INSTALLED}${PATH_SUFFIX_${_buildtype}}/lib")
                set(_link_path "${_VCPKG_INSTALLED}${PATH_SUFFIX_${_buildtype}}/lib${VCPKG_HOST_PATH_SEPARATOR}")
            endif()
            if(EXISTS "${_VCPKG_INSTALLED}${PATH_SUFFIX_${_buildtype}}/lib/manual-link")
                set(_link_path "${_link_path}${_VCPKG_INSTALLED}${PATH_SUFFIX_${_buildtype}}/lib/manual-link${VCPKG_HOST_PATH_SEPARATOR}")
            endif()

...
function(vcpkg_configure_make)
    ...
    if (CMAKE_HOST_WIN32)
        ...
        ## TODO: Add VCPKG_DETECTED vars here!
        if (_csc_AUTOCONFIG) # without autotools we assume a custom configure script which correctly handles cl and lib. Otherwise the port needs to set CC|CXX|AR and probably CPP
            _vcpkg_append_to_configure_environment(CONFIGURE_ENV CPP "compile cl.exe -E")
            _vcpkg_append_to_configure_environment(CONFIGURE_ENV CC "compile cl.exe ")
            _vcpkg_append_to_configure_environment(CONFIGURE_ENV CXX "compile cl.exe ")
            _vcpkg_append_to_configure_environment(CONFIGURE_ENV AR "ar-lib lib.exe -verbose")
        else()
            _vcpkg_append_to_configure_environment(CONFIGURE_ENV CPP "cl.exe -E")
            _vcpkg_append_to_configure_environment(CONFIGURE_ENV CC "cl.exe")
            _vcpkg_append_to_configure_environment(CONFIGURE_ENV CXX "cl.exe")
    ...
    if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "debug" AND NOT _csc_NO_DEBUG)
        ...
        set(CPPFLAGS_${_VAR_SUFFIX} "${VCPKG_DETECTED_COMBINED_CFLAGS_${_VAR_SUFFIX}}")

...
function(vcpkg_configure_make)
    ...
    if(_csc_GENERATOR MATCHES "NMake")
        message(FATAL_ERROR "Sorry, NMake is not supported currently.")
        if (CMAKE_HOST_WIN32)
            set(GENERATOR "nmake")
        else()
            set(GENERATOR "make")
    ...
    if(NOT CMAKE_HOST_WIN32)
        find_program(AR "ar")
        if(NOT AR MATCHES "/usr/bin/ar")
            message(WARNING "ar is not the system default one. Strange errors might happen, in that case it is necessary to modify your PATH environment variable in order to have /usr/bin before your current ar location (${AR}). Remember to check /usr/libexec/path_helper in case you are on macOS")
        endif()
    endif()

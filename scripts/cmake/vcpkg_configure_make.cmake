...
function(vcpkg_configure_make)
    ...
    if (CMAKE_HOST_WIN32)
        ...
        if (NOT _csc_DISABLE_AUTO_HOST)
            ...
            if(VCPKG_TARGET_ARCHITECTURE STREQUAL x86)
                set(BUILD_TARGET --target=i686-pc-msys) #${MINGW_TARGET})
                set(HOST_TYPE --host=i686-pc-windows)
            elseif(VCPKG_TARGET_ARCHITECTURE STREQUAL x64)
                set(BUILD_TARGET "x86_64-pc-mingw32") #${MINGW_TARGET})
        ...
        set(ENV{CCLD} link)
        set(ENV{LD} link)
        set(COMPILER_CC "CC=cccl CPP=cccl CXX=cccl CCLD=link LD=link")
        #set(COMPILER_CC "CC='cl' CXX='cl' LD='cl'")
    ...
    if(NOT VCPKG_TARGET_IS_WINDOWS)
        ...
        string(APPEND C_FLAGS_GLOBAL " /DWIN32")
        string(APPEND CXX_FLAGS_GLOBAL " /DWIN32")
    endif()

...
macro(_vcpkg_extract_cpp_flags_and_set_cflags_and_cxxflags _SUFFIX)
    ...
    string(APPEND CFLAGS_${_SUFFIX} " ${VCPKG_DETECTED_CMAKE_INCLUDE_FLAG_C}${VCPKG_DETECTED_CMAKE_INCLUDE_FLAG_C_SEP}${VCPKG_INCLUDE_PATH}")
    string(APPEND CXXFLAGS_${_SUFFIX} " ${VCPKG_DETECTED_CMAKE_INCLUDE_FLAG_CXX}${VCPKG_DETECTED_CMAKE_INCLUDE_FLAG_CXX_SEP}${VCPKG_INCLUDE_PATH}")

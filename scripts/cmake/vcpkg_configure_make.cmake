...
macro(_vcpkg_extract_cpp_flags_and_set_cflags_and_cxxflags _SUFFIX _FOR_BUILD)
    ...
    string(APPEND CFLAGS_${VAR_SUFFIX} " ${INCLUDE_FLAG_C}${INCLUDE_FLAG_C_SEP}${VCPKG_INCLUDE_PATH}")
    string(APPEND CXXFLAGS_${VAR_SUFFIX} " ${INCLUDE_FLAG_CXX}${INCLUDE_FLAG_CXX_SEP}${VCPKG_INCLUDE_PATH}")

...
macro(z_prepend_include_path var)
    ...
    if(NOT DEFINED z_vcpkg_env_backup_${var} OR "${z_vcpkg_env_backup_${var}}" STREQUAL "")
        ...
        foreach (one_bk IN ITEMS ${z_vcpkg_env_backup_${var}})
            # The backup variable may contains ${VCPKG_HOST_PATH_SEPARATOR}
            string(REPLACE "${VCPKG_HOST_PATH_SEPARATOR}" [[;]] one_bk_with_semicolon "${one_bk}")
            vcpkg_host_path_list(PREPEND ENV{${var}} "${one_bk_with_semicolon}")
        endforeach()

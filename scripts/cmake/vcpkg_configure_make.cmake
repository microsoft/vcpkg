...
function(vcpkg_configure_make)
    ...
    if (CMAKE_HOST_WIN32)
        ...
        string(REPLACE ";$ENV{SystemRoot}\\system32;" "${APPEND_ENV};${MSYS_ROOT}/usr/bin;$ENV{SystemRoot}\\system32;" NEWPATH "$ENV{PATH}")
        string(REPLACE "\\" "/" SYSROOT $ENV{SystemRoot})
        string(REPLACE "\\" "/" MYPATH $ENV{MYPATH})
        debug_message("SystemRoot:${SYSROOT}")
        debug_message("PATH:${MYPATH}")
        set(ENV{PATH} "${NEWPATH}")
        string(REPLACE "\\" "/" MYPATH $ENV{MYPATH})
        debug_message("NEW_PATH:${MYPATH}")

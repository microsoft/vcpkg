...
function(vcpkg_get_cmake_vars)
    ...
    file(RENAME "${CURRENT_BUILDTREES_DIR}/config-${TARGET_TRIPLET}-out.log" "${CURRENT_BUILDTREES_DIR}/get-cmake-vars-${TARGET_TRIPLET}-out.log")
    file(RENAME "${CURRENT_BUILDTREES_DIR}/config-${TARGET_TRIPLET}-err.log" "${CURRENT_BUILDTREES_DIR}/get-cmake-vars-${TARGET_TRIPLET}-err.log")
endfunction()
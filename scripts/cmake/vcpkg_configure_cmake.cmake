...
function(vcpkg_configure_cmake)
    ...
    if(VCPKG_LIBRARY_LINKAGE STREQUAL "${VCPKG_ROOT_DIR}/scripts/toolchains/dynamic.cmake")
        list(APPEND _csc_OPTIONS -DBUILD_SHARED_LIBS=ON)
    elseif(VCPKG_LIBRARY_LINKAGE STREQUAL "${VCPKG_ROOT_DIR}/scripts/toolchains/static.cmake")
    ...
    if(NINJA_HOST AND CMAKE_HOST_WIN32 AND NOT _csc_DISABLE_PARALLEL_CONFIGURE)
        ...
        if(NOT DEFINED VCPKG_BUILD_TYPE)
            _build_cmakecache(".." "${VCPKG_ROOT_DIR}/scripts/toolchains/rel.cmake")
            _build_cmakecache("../../${TARGET_TRIPLET}-dbg" "${VCPKG_ROOT_DIR}/scripts/toolchains/dbg.cmake")
        elseif(VCPKG_BUILD_TYPE STREQUAL "${VCPKG_ROOT_DIR}/scripts/toolchains/release.cmake")
            _build_cmakecache(".." "${VCPKG_ROOT_DIR}/scripts/toolchains/rel.cmake")
        elseif(VCPKG_BUILD_TYPE STREQUAL "${VCPKG_ROOT_DIR}/scripts/toolchains/debug.cmake")
            _build_cmakecache("../../${TARGET_TRIPLET}-dbg" "${VCPKG_ROOT_DIR}/scripts/toolchains/dbg.cmake")
        endif()
        ...
        if(NOT DEFINED VCPKG_BUILD_TYPE)
            _configure_target_triplet("${VCPKG_ROOT_DIR}/scripts/toolchains/dbg.cmake")
            _configure_target_triplet("${VCPKG_ROOT_DIR}/scripts/toolchains/rel.cmake")
        elseif(VCPKG_BUILD_TYPE STREQUAL "${VCPKG_ROOT_DIR}/scripts/toolchains/debug.cmake")
            _configure_target_triplet("${VCPKG_ROOT_DIR}/scripts/toolchains/dbg.cmake")
        elseif(VCPKG_BUILD_TYPE STREQUAL "${VCPKG_ROOT_DIR}/scripts/toolchains/release.cmake")
            _configure_target_triplet("${VCPKG_ROOT_DIR}/scripts/toolchains/rel.cmake")

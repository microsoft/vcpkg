...
function(vcpkg_configure_meson)
    ...
    if(VCPKG_TARGET_IS_OSX)
        if(DEFINED ENV{SDKROOT})
            set(ENV_SDKROOT_BACKUP $ENV{SDKROOT})
        endif()
        set(ENV{SDKROOT} "${VCPKG_DETECTED_CMAKE_OSX_SYSROOT}")
        if(DEFINED ENV{MACOSX_DEPLOYMENT_TARGET})
            set(ENV_MACOSX_DEPLOYMENT_TARGET_BACKUP $ENV{MACOSX_DEPLOYMENT_TARGET})
        endif()
    ...
    if(VCPKG_TARGET_IS_OSX)
        if(DEFINED ENV_SDKROOT_BACKUP)
            set(ENV{SDKROOT} "${ENV_SDKROOT_BACKUP}")
        else()
            unset(ENV{SDKROOT})
        endif()
        if(DEFINED ENV_MACOSX_DEPLOYMENT_TARGET_BACKUP)
            set(ENV{MACOSX_DEPLOYMENT_TARGET} "${ENV_MACOSX_DEPLOYMENT_TARGET_BACKUP}")
        else()

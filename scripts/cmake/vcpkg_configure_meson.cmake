function(vcpkg_configure_meson)
    ...
    elseif(CMAKE_HOST_UNIX)
        set(MESON_COMMON_CFLAGS   "${MESON_COMMON_CFLAGS} -pthread")
        set(MESON_COMMON_CXXFLAGS "${MESON_COMMON_CXXFLAGS} -pthread")
        set(MESON_COMMON_LDFLAGS  "${MESON_COMMON_LDFLAGS} -pthread")
    endif()

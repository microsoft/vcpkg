function(vcpkg_configure_meson)
    ...
    set(MESON_COMMON_CFLAGS "${MESON_COMMON_CFLAGS} ${CMAKE_C_FLAGS${_MESON_FLAG_SUFFIX}}")
    set(MESON_COMMON_CXXFLAGS "${MESON_COMMON_CXXFLAGS} ${CMAKE_CXX_FLAGS${_MESON_FLAG_SUFFIX}}")
    ...
    list(APPEND _vcm_OPTIONS --buildtype plain --backend ninja --wrap-mode nodownload --errorlogs)

...
function(vcpkg_internal_meson_generate_native_file _additional_binaries) #https://mesonbuild.com/Native-environments.html
    ...
    if(VCPKG_DETECTED_CMAKE_LINKER AND VCPKG_TARGET_IS_WINDOWS)
        ...
        elseif (NOT VCPKG_DETECTED_CMAKE_C_COMPILER STREQUAL VCPKG_DETECTED_CMAKE_LINKER)
            message(FATAL_ERROR "The linker and compiler executable must be the same for gcc and icc. Use -fuse-ld=... to change the linker backend.\nVCPKG_DETECTED_CMAKE_C_COMPILER=${VCPKG_DETECTED_CMAKE_C_COMPILER}\nVCPKG_DETECTED_CMAKE_LINKER=${VCPKG_DETECTED_CMAKE_LINKER}")
        endif()
    endif()
    if(VCPKG_DETECTED_CMAKE_LINKER AND VCPKG_TARGET_IS_WINDOWS)
        ...
        message(FATAL_ERROR "The linker and compiler executable must be the same for gcc and icc. Use -fuse-ld=... to change the linker backend.\nVCPKG_DETECTED_CMAKE_CXX_COMPILER=${VCPKG_DETECTED_CMAKE_CXX_COMPILER}\nVCPKG_DETECTED_CMAKE_LINKER=${VCPKG_DETECTED_CMAKE_LINKER}")
        endif()
    endif()

...
function(z_vcpkg_meson_generate_flags_properties_string out_var config_type)
    ...
    if(VCPKG_TARGET_IS_OSX AND VCPKG_DETECTED_CMAKE_OSX_DEPLOYMENT_TARGET)
        vcpkg_list(APPEND cflags "-mmacosx-version-min=${VCPKG_DETECTED_CMAKE_OSX_DEPLOYMENT_TARGET}")
    endif()
    ...
    if(VCPKG_TARGET_IS_OSX AND VCPKG_DETECTED_CMAKE_OSX_DEPLOYMENT_TARGET)
        vcpkg_list(APPEND cxxflags "-mmacosx-version-min=${VCPKG_DETECTED_CMAKE_OSX_DEPLOYMENT_TARGET}")
    endif()

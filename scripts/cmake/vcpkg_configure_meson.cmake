function(z_vcpkg_meson_set_proglist_variables config_type)
    ...
    endforeach()
    set(compilers "${arg_LANGUAGES}" RC)
...
function(z_vcpkg_meson_setup_variables config_type)
    set(meson_var_list VSCRT_LINKAGE WINLIBS MT AR C C_LD CXX CXX_LD OBJC OBJC_LD OBJCXX OBJCXX_LD FC FC_LD WINDRES CFLAGS CXXFLAGS OBJCFLAGS OBJCXXFLAGS FCFLAGS SHARED_LINKER_FLAGS)
...
function(vcpkg_configure_meson)
    ...
    if(DEFINED arg_ADDITIONAL_NATIVE_BINARIES OR DEFINED arg_ADDITIONAL_CROSS_BINARIES)
        message(WARNING "arg_ADDITIONAL_(NATIVE|CROSS)_BINARIES has been deprecated. Only use ADDITIONAL_BINARIES!")
    endif()

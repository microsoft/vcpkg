...
function(z_vcpkg_meson_convert_compiler_flags_to_list out_var _compiler_flags)
...
function(z_vcpkg_meson_generate_flags_properties_string out_var config_type)
    ...
    z_vcpkg_meson_convert_compiler_flags_to_list(MESON_CFLAGS_${config_type} "${VCPKG_DETECTED_CMAKE_C_FLAGS_${config_type}}")
    vcpkg_list(APPEND MESON_CFLAGS_${config_type} "-I${CURRENT_INSTALLED_DIR}/include")
    z_vcpkg_meson_convert_list_to_python_array(MESON_CFLAGS_${config_type} ${MESON_CFLAGS_${config_type}})
    string(APPEND ${out_var} "c_args = ${MESON_CFLAGS_${config_type}}\n")
    z_vcpkg_meson_convert_compiler_flags_to_list(MESON_CXXFLAGS_${config_type} "${VCPKG_DETECTED_CMAKE_CXX_FLAGS_${config_type}}")
    vcpkg_list(APPEND MESON_CXXFLAGS_${config_type} "-I${CURRENT_INSTALLED_DIR}/include")
    z_vcpkg_meson_convert_list_to_python_array(MESON_CXXFLAGS_${config_type} ${MESON_CXXFLAGS_${config_type}})
    ...
    z_vcpkg_meson_convert_compiler_flags_to_list(LINKER_FLAGS_${config_type} "${LINKER_FLAGS_${config_type}}")
    vcpkg_list(APPEND LINKER_FLAGS_${config_type} "${libpath_${config_type}}")
    z_vcpkg_meson_convert_list_to_python_array(LINKER_FLAGS_${config_type} ${LINKER_FLAGS_${config_type}})

...
function(vcpkg_install_msbuild)
    ...
    if(DEFINED _csc_INCLUDES_SUBPATH)
        get_filename_component(_csc_INCLUDES_SUBPATH "${_csc_INCLUDES_SUBPATH}" ABSOLUTE BASE_DIR "${_csc_SOURCE_PATH}")
        file(COPY ${_csc_INCLUDES_SUBPATH}/ DESTINATION ${CURRENT_PACKAGES_DIR}/include/)
    ...
    if(DEFINED _csc_LICENSE_SUBPATH)
        get_filename_component(_csc_LICENSE_SUBPATH "${_csc_LICENSE_SUBPATH}" ABSOLUTE BASE_DIR "${_csc_SOURCE_PATH}")
        file(INSTALL ${_csc_LICENSE_SUBPATH} DESTINATION ${CURRENT_PACKAGES_DIR}/share/${PORT} RENAME copyright)
    endif()
endfunction()

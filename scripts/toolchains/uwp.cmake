...
if(NOT _CMAKE_IN_TRY_COMPILE)
    ...
    if(NOT (VCPKG_CRT_LINKAGE STREQUAL "dynamic" OR VCPKG_CRT_LINKAGE STREQUAL "static"))
    ...
    set(CMAKE_CXX_FLAGS_DEBUG "/Od /RTC1 ${VCPKG_CXX_FLAGS_DEBUG}" CACHE STRING "")
    set(CMAKE_C_FLAGS_DEBUG "/Od /RTC1 ${VCPKG_C_FLAGS_DEBUG}" CACHE STRING "")

    set(CMAKE_CXX_FLAGS_RELEASE "/O2 /Oi /Gy /DNDEBUG ${VCPKG_CXX_FLAGS_RELEASE}" CACHE STRING "") # VS adds /GL
    set(CMAKE_C_FLAGS_RELEASE "/O2 /Oi /Gy /DNDEBUG ${VCPKG_C_FLAGS_RELEASE}" CACHE STRING "")

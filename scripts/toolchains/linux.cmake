if(NOT _VCPKG_LINUX_TOOLCHAIN)
    ...
    set(_vcpkg_gnu_prefix "")
    if(VCPKG_TARGET_ARCHITECTURE STREQUAL "x64")
        set(CMAKE_SYSTEM_PROCESSOR x86_64 CACHE STRING "")
        set(_vcpkg_gnu_prefix "x86_64-linux-gnu")
    elseif(VCPKG_TARGET_ARCHITECTURE STREQUAL "x86")
        set(CMAKE_SYSTEM_PROCESSOR i686 CACHE STRING "")
        set(_vcpkg_gnu_prefix "i686-linux-gnu")
    elseif(VCPKG_TARGET_ARCHITECTURE STREQUAL "arm")
        set(CMAKE_SYSTEM_PROCESSOR armv7l CACHE STRING "")
        set(_vcpkg_gnu_prefix "arm-linux-gnueabihf")
    elseif(VCPKG_TARGET_ARCHITECTURE STREQUAL "arm64")
        set(CMAKE_SYSTEM_PROCESSOR aarch64 CACHE STRING "")
        set(_vcpkg_gnu_prefix "aarch64-linux-gnu")
    endif()
    if(_vcpkg_gnu_prefix)
        if(NOT DEFINED CMAKE_C_COMPILER)
            set(CMAKE_C_COMPILER "${_vcpkg_gnu_prefix}-gcc")
        endif()
        if(NOT DEFINED CMAKE_CXX_COMPILER)
            set(CMAKE_CXX_COMPILER "${_vcpkg_gnu_prefix}-g++")
        endif()
        if(NOT DEFINED CMAKE_ASM_COMPILER)
            set(CMAKE_ASM_COMPILER "${_vcpkg_gnu_prefix}-gcc")
        endif()
        if(NOT DEFINED CMAKE_ASM-ATT_COMPILER)
            set(CMAKE_ASM-ATT_COMPILER "${_vcpkg_gnu_prefix}-as")
        endif()
    endif()
    unset(_vcpkg_gnu_prefix)

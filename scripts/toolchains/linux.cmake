if(NOT _VCPKG_LINUX_TOOLCHAIN)
    ...
    if(NOT DEFINED VCPKG_PLATFORM_TOOLSET)
        set(VCPKG_PLATFORM_TOOLSET "gcc")  # Default to gcc to preserve legacy behavior.
    endif()
    string(TOLOWER "${VCPKG_PLATFORM_TOOLSET}" VCPKG_PLATFORM_TOOLSET_LOWER)
    ...
    if(VCPKG_PLATFORM_TOOLSET_LOWER STREQUAL "clang")
        ...
        elseif(VCPKG_TARGET_ARCHITECTURE STREQUAL "riscv64")
            set(CLANG_TARGET riscv64-unknown-linux-gnu)
        endif()
    ...
    else()  # VCPKG_PLATFORM_TOOLSET_LOWER STREQUAL "gcc"
        ...
        if(VCPKG_TARGET_ARCHITECTURE STREQUAL "arm")
            if(CMAKE_HOST_SYSTEM_NAME STREQUAL "Linux" AND NOT CMAKE_HOST_SYSTEM_PROCESSOR STREQUAL "armv7l")
                ...
                if(NOT DEFINED CMAKE_ASM_ATT_COMPILER)
                    set(CMAKE_ASM_ATT_COMPILER "arm-linux-gnueabihf-as")
                endif()
        ...
        elseif(VCPKG_TARGET_ARCHITECTURE STREQUAL "arm64")
            if(CMAKE_HOST_SYSTEM_NAME STREQUAL "Linux" AND NOT CMAKE_HOST_SYSTEM_PROCESSOR STREQUAL "aarch64")
                ...
                if(NOT DEFINED CMAKE_ASM_ATT_COMPILER)
                    set(CMAKE_ASM_ATT_COMPILER "aarch64-linux-gnu-as")
                endif()
        ...
        elseif(VCPKG_TARGET_ARCHITECTURE STREQUAL "riscv64")
            if(CMAKE_HOST_SYSTEM_NAME STREQUAL "Linux" AND NOT CMAKE_HOST_SYSTEM_PROCESSOR STREQUAL "riscv64")
                ...
                if(NOT DEFINED CMAKE_ASM_ATT_COMPILER)
                    set(CMAKE_ASM_ATT_COMPILER "riscv64-linux-gnu-as")
                endif()

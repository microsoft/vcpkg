...
cmake_host_system_information(RESULT VCPKG_HOST_PLATFORM QUERY OS_PLATFORM)
cmake_host_system_information(RESULT VCPKG_HOST_IS_64BIT QUERY IS_64BIT)
if(VCPKG_HOST_IS_64BIT)
    if(VCPKG_HOST_PLATFORM STREQUAL "x86")
        set(VCPKG_HOST_PLATFORM "AMD64")
    elseif(VCPKG_HOST_PLATFORM STREQUAL "ARM")
        set(VCPKG_HOST_PLATFORM "ARM64")
    endif()
endif()
if(NOT CMAKE_SYSTEM_PROCESSOR MATCHES "${VCPKG_HOST_PLATFORM}")
    if(VCPKG_HOST_PLATFORM STREQUAL "AMD64" AND CMAKE_SYSTEM_PROCESSOR STREQUAL "x86") # since AMD64 can run x86 code
    elseif(VCPKG_HOST_PLATFORM STREQUAL "ARM64" AND CMAKE_SYSTEM_PROCESSOR STREQUAL "ARM") # since ARM64 can (probably?) run ARM code
    elseif(VCPKG_HOST_PLATFORM STREQUAL "ARM64" AND CMAKE_SYSTEM_PROCESSOR STREQUAL "x86") # since ARM64 can run x86 code
    else() # Otherwise force CMAKE_CROSSCOMPILING to avoid running non runable code/tests. 

...
if(NOT _CMAKE_IN_TRY_COMPILE)
    ...
    if(VCPKG_TARGET_ARCHITECTURE STREQUAL "arm64ec")
        set(CMAKE_CXX_FLAGS " /nologo /DWIN32 /D_WINDOWS /D_AMD64_ /DAMD64 /D_ARM64EC_ /DARM64EC /W3 ${CHARSET_FLAG} /GR /EHsc /MP ${VCPKG_CXX_FLAGS}" CACHE STRING "")
        set(CMAKE_C_FLAGS " /nologo /DWIN32 /D_WINDOWS /D_AMD64_ /DAMD64 /D_ARM64EC_ /DARM64EC /W3 ${CHARSET_FLAG} /MP ${VCPKG_C_FLAGS}" CACHE STRING "")
    else()

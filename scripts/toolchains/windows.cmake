...
if(NOT _CMAKE_IN_TRY_COMPILE)
    ...
    get_property( _CMAKE_IN_TRY_COMPILE GLOBAL PROPERTY IN_TRY_COMPILE )
    if(NOT _CMAKE_IN_TRY_COMPILE)
        string(APPEND CMAKE_SHARED_LINKER_FLAGS " /PDB:${CMAKE_BINARY_DIR}/${VCPKG_PORT}.pdb /PDBALTPATH:%_PDB% /PDBSTRIPPED:strip_%_PDB%")
        string(APPEND CMAKE_STATIC_LINKER_FLAGS " /PDB:${CMAKE_BINARY_DIR}/${VCPKG_PORT}.pdb /PDBALTPATH:%_PDB% /PDBSTRIPPED:strip_%_PDB%")
        string(APPEND CMAKE_EXE_LINKER_FLAGS " /PDB:${CMAKE_BINARY_DIR}/${VCPKG_PORT}.pdb /PDBALTPATH:%_PDB% /PDBSTRIPPED:strip_%_PDB%")
        cmake_language(DEFER DIRECTORY "${CMAKE_SOURCE_DIR}" CALL "
            install(FILES "${CMAKE_BINARY_DIR}/${VCPKG_PORT}.pdb" TYPE BIN)
        ")
    endif()

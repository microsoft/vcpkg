...
if(NOT _CMAKE_IN_TRY_COMPILE)
    ...
    set(Z_VCPKG_CHARSET_FLAG "/utf-8")
    if (NOT VCPKG_SET_CHARSET_FLAG OR CMAKE_GENERATOR_PLATFORM MATCHES "^Visual Studio 12 2013")
        # VS 2013 does not support /utf-8
        set(Z_VCPKG_CHARSET_FLAG "")
    endif()

    set(CMAKE_CXX_FLAGS " /nologo /DWIN32 /D_WINDOWS /W3 ${Z_VCPKG_CHARSET_FLAG} /GR /EHsc /MP ${VCPKG_CXX_FLAGS}" CACHE STRING "")
    set(CMAKE_C_FLAGS " /nologo /DWIN32 /D_WINDOWS /W3 ${Z_VCPKG_CHARSET_FLAG} /MP ${VCPKG_C_FLAGS}" CACHE STRING "")

...
if(NOT _CMAKE_IN_TRY_COMPILE)
    ...
    # Use /Z7 for static libs to embed debug info
    if(VCPKG_LIBRARY_LINKAGE STREQUAL "static")
        set(DEBUG_INFORMATION_FORMAT "/Z7")
    elseif(VCPKG_LIBRARY_LINKAGE STREQUAL "dynamic")
        set(DEBUG_INFORMATION_FORMAT "/Zi")
    else()
    ...
    set(CMAKE_CXX_FLAGS " /nologo /DWIN32 /D_WINDOWS /W3 ${DEBUG_INFORMATION_FORMAT} ${CHARSET_FLAG} /GR /EHsc /MP ${VCPKG_CXX_FLAGS}" CACHE STRING "")
    set(CMAKE_C_FLAGS " /nologo /DWIN32 /D_WINDOWS /W3 ${DEBUG_INFORMATION_FORMAT} ${CHARSET_FLAG} /MP ${VCPKG_C_FLAGS}" CACHE STRING "")
    set(CMAKE_RC_FLAGS "-c65001 /DWIN32" CACHE STRING "")

    unset(CHARSET_FLAG)
    unset(DEBUG_INFORMATION_FORMAT)

    set(CMAKE_CXX_FLAGS_DEBUG "/D_DEBUG ${VCPKG_CRT_LINK_FLAG_PREFIX}d /Ob0 /Od /RTC1 ${VCPKG_CXX_FLAGS_DEBUG}" CACHE STRING "")
    set(CMAKE_C_FLAGS_DEBUG "/D_DEBUG ${VCPKG_CRT_LINK_FLAG_PREFIX}d /Ob0 /Od /RTC1 ${VCPKG_C_FLAGS_DEBUG}" CACHE STRING "")
